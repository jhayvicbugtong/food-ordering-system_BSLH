<?php
// staff/actions/get_menu_items.php
...
// Check auth: Allow 'staff' (and 'admin' if they visit this endpoint)
...
if (!empty($search)) {
    ...
    $stmt->bind_param("ii", ...$params_data);
}
...
if ($result->num_rows > 0) {
    ...
    $html = '<tr><td colspan="5" class="text-center text-muted py-4">No menu items found.</td></tr>';
}
