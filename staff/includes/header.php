...
<head>
  ...
  <style>
  /* Enhanced Header Styles - Copied from Admin */
  .site-header {
  ...
  <div class="container-fluid">
    <div class="header-content">
      <div class="brand-container">
        ...
        <img src="<?= htmlspecialchars($BASE_URL) ?>/uploads/logo/logo_transparent.png" alt="Avocado Logo" class="brand-logo">
      ...
      <div class="user-nav">
        ...
        <div class="user-dropdown">
          <div class="user-profile" id="userDropdown">
            ...
            <div class="user-info">
              <div class="user-name"><?= htmlspecialchars(get_user_name() ?? 'Staff User') ?></div>
          ...
          <div class="dropdown-menu" id="profileDropdown">
            <a href="<?= htmlspecialchars($BASE_URL) ?>/staff/profile.php" class="dropdown-item">
