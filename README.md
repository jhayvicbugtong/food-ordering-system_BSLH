...
The system serves three user account types: Customers, Staff, and Administrators.
...
* *Context Diagram (Level 0):* Shows data flow between Customer, Staff, Admin, and the Food Ordering System.
