...

{
            ...
            "@type": "Restaurant",
            "name": "Strona główna",
            "url": "https://avocado-en.orderwebsite.com/",
            "logo": "",
            "image": "https://cs.cdn-upm.com/themes/98dfb947-4a04-11ed-8bca-525400080621/assets-6/cover.jpg",
            "description": "",
            ...
            "telephone": "+1 123123123",
            "menu": "https://avocado-en.orderwebsite.com/menu/menu",
...
<div class="_shopping-cart-container" id="_shopping-cart" data-hidden-errors="{{#unless cart.items}}{{message " cms_cart_empty "}}{{/unless}}">
            ...
            <div class="_mobile-cart">
                ...
                <div class="btn-flex mobile-checkout-btn">
                    {{#if tableNumber}} {{#ifequal site.languages.size 1}} {{else}}
                ...
                {{#if cart.items}}
                    <span class="pos-rlt pull-left m-r-sm">
                        ...
                        {{toCurrency cart.totalCost site.currency language}} {{else}}
                        <span class="pos-rlt pull-left m-r-sm">
                        <svg width="23" height="24" viewBox="0 0 23 24" fill="none" stroke="currentColor" class="v-middle m-t-n-xxs" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_374_2314)">
                                <path d="M18.7097 21.3224C19.2263 21.3224 19.6451 20.9036 19.6451 20.3869C19.6451 19.8702 19.2263 19.4514 18.7097 19.4514C18.193 19.4514 17.7742 19.8702 17.7742 20.3869C17.7742 20.9036 18.193 21.3224 18.7097 21.3224Z" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    </span> {{toCurrency 0 site.currency language}} {{/if}}
                        </span>
                    </div>
                    <a href="index.html#" class="btn btn-upmenu btn-lg {{#if cart.items}}{{else}}disabled{{/if}} _start-order {{#if editMode}}disabled{{/if}}">
                ...
                <div class="_mobile-cart-errors" style="display: none; margin-top: 15px; margin-bottom: 0px;">
                    ...
                    <div class="alert alert-danger">
                        <a class="close" href="index.html#" onclick="jQuery('._mobile-cart-errors').hide(); return false;">&times;</a> {{#cart.errors}} {{.}} {{/cart.errors}}
                    </div>
                    {{/if}}
                </div>
                <!-- MOBILE CART ERRORSS -->
            ...
            <div class="cart hidden-xs _desktop-cart">
                <div class="theme-cart-inner">
                    ...
                    <ul id="scroll-items" class="cart-items-scrollable cart-scrollbar list-unstyled">
                        ...
                        <li data-pid="{{productPriceId}}" data-id="{{id}}" class="cart-menu-item">
                            <div>
                                ...
                                <div class="addon">
                                    {{#addons}} {{#if quantity}} {{#if defaultQuantity}} {{else}}
                                    <p>+ {{#ifequal quantity "1"}}{{else}}{{toQty quantity}} x {{/ifequal}}{{name}} ( {{toCurrency price ../../site.currency @root.language}} {{#if oldPrice}}
                                ...
                                {{/if}} {{#if buyingFlowId}}
                                <a href="index.html#" id="{{id}}" data-pid="{{productPriceId}}" data-product-id="{{productId}}" data-pquantity="{{quantity}}" class="edit-buying-flow-id pull-left m-r-xs">{{message "cms_buying_flow_edit_product"}}</a> {{/if}}
                            </div>
                            <div class="price">
                                <div>
                                    <div class="price-value no-wrap">
                                        {{toCurrency price ../site.currency @root.language}} {{#if oldPrice}}
                                        <div title="{{#discounts}} {{.}} {{/discounts}}" data-toggle="tooltip"><span class="cross">{{toCurrency oldPrice ../site.currency @root.language}} </span></div>{{/if}}
                                    </div>
                                    <div class="clearfix m-t-xs">
                                        <a href="index.html#" id="{{id}}" data-pid="{{productPriceId}}" data-product-id="{{productId}}" class="increase-cart-item cart-icon btn plus theme-plus pull-right">+</a>
                                        <a href="index.html#" id="{{id}}" data-pid="{{productPriceId}}" data-product-id="{{productId}}" data-pquantity="{{quantity}}" class="decrease-cart-item cart-icon btn plus theme-plus pull-right m-r-xs">−</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        {{/cart.items}}
                        <a href="index.html#" class="more-items-btn showMore"><i class="fa fa-angle-down"></i> {{message "order_show_more"}}</a>
                    </ul>
                    <div class="separator"></div>
                    {{/if}} {{#unless cart.items}}
                    <div class="text-center"><img src="https://avocado-en.orderwebsite.com/{{{static_url}}}/images/themes/cart.png" class="theme-empty-cart-img" /></div>
                    ...
                    <ul class="list-unstyled cart-summary">
                        ...
                        <li class="clearfix">
                            <div class="pull-right price">
                                {{toCurrency cart.productsCost site.currency language}} {{#if cart.oldProductsCost}}
                                <div class="cross">{{toCurrency cart.oldProductsCost site.currency language}}</div>{{/if}}
                            </div>
                        ...
                        <li class="clearfix theme-set-delivery-address">
                            <div class="pull-right price delivery-price">
                                {{#ifequal cart.deliveryStatus "DELIVERY"}} {{#ifequal cart.deliveryCost 0}} {{message "cms_cart_freeDelivery"}} {{else}} {{toCurrency cart.deliveryCost site.currency language}} {{/ifequal}} {{else}} {{#ifnull cart.minDeliveryCost}} {{else}} {{toCurrency
                                cart.minDeliveryCost site.currency language}} {{/ifnull}} {{#ifnull cart.maxDeliveryCost}} {{else}} {{#ifequal cart.maxDeliveryCost 0}} {{message "cms_cart_freeDelivery"}} {{else}} {{#ifnull cart.minDeliveryCost}} {{else}}
                                - {{/ifnull}} {{toCurrency cart.maxDeliveryCost site.currency language}} {{/ifequal}} {{/ifnull}} {{/ifequal}} {{#ifnull cart.oldDeliveryCost}} {{else}}
                                <div class="cross" title="{{#cart.deliveryDiscounts}} {{.}} {{/cart.deliveryDiscounts}}" data-toggle="tooltip">{{toCurrency cart.oldDeliveryCost site.currency language}}</div>{{/ifnull}}
                            </div>
                            <div>
                                {{message "cms_cart_delivery"}} {{#ifnull cart.oldDeliveryCost}} {{else}}
                        ...
                        <li class="clearfix theme-cart-package">
                            <div class="pull-right price package-price">
                                {{toCurrency cart.packageCostWithoutSup site.currency language}} {{#if cart.oldPackageCost}}
                                <div class="cross">{{toCurrency cart.oldPackageCost site.currency language}}</div>{{/if}}
                            </div>
                            <div>
                                <span>{{message "cms_cart_packaging_cost"}}</span>
                                <svg class="color-0 v-middle m-t-n-3xxs" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-toggle="tooltip" data-html="true"
                                    title='
                        ...
                        <li class="clearfix theme-cart-package">
                            ...
                            <div>
                                ...
                                <svg class="color-0 v-middle m-t-n-3xxs" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-toggle="tooltip" title="{{message "
                                    cms_cart_sup_tooltip "}}">
									<circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line>
								</svg>
                            </div>
                        </li>
                        ...
                        {{/if}}
                        <!-- PROCESSING FEE -->
                        {{#if cart.processingFees}} {{#cart.processingFees}}
                        ...
                        {{/cart.processingFees}} {{/if}}
                        <!-- Taxes -->
                        {{#if cart.tax.taxes}} {{#each cart.tax.taxes}}
                        ...
                        <li class="clearfix theme-cart-tips">
                            ...
                            <div class="btn-group d-flex {{#if cart.tipRequired}} radio-btns {{/if}} media-flex m-t-xs" role="group" aria-label="...">
                                {{#restaurant.tipPercentage}} {{#if ../cart.tipRequired}}
                                <input type="radio" class="btn-check hidden radio-single-check" name="tip" id="tip{{.}}" autocomplete="off" {{#ifequal ../cart.tipType "PERCENT"}} {{#ifequal ../cart.tip .}}checked{{/ifequal}}{{/ifequal}}>
                                <label class="btn btn-default flex-fill single-tip _set-tip radio-single
                                                {{#ifequal ../cart.tipType " PERCENT "}}{{#ifequal ../cart.tip .}}selected{{/ifequal}}{{/ifequal}}" for="tip{{.}}" data-tip="{{.}}" data-tipType="PERCENT">{{.}}%</label>                                {{else}}
                                <button type="button" class="btn btn-default flex-fill _set-tip
                                            {{#ifequal ../cart.tipType " PERCENT "}}
                                                {{#ifequal ../cart.tip .}}selected{{/ifequal}}
                                            {{/ifequal}}" data-tip="{{.}}" data-tipType="PERCENT">
                                            {{.}}%
                                        </button> {{/if}} {{/restaurant.tipPercentage}}
                                <button type="button" class="btn btn-default flex-fill _custom-tip
                                        {{#ifequal cart.tipType " AMOUNT " "PERCENT "}}
                                            {{#ifequal cart.tip restaurant.tipPercentage.[0] restaurant.tipPercentage.[1] restaurant.tipPercentage.[2] 0}}{{else}}
                                                selected
                                            {{/ifequal}}
                                        {{/ifequal}}" data-toggle="popover" data-html="true" data-placement="left" data-template="<div class='popover tip-amount' role='tooltip' style='right: 60px'><div class='arrow'></div><div class='popover-content wrapper'></div></div>"
                                    data-content='<div class="popover-header">{{message "cart_tip_amount"}} <a href="index.html#!" class="_close-set-tip"><i class="fa fa-close pull-right"></i></a></div>
                        ...
                        <li class="clearfix total theme-cart-total">
                            <div class="pull-right price total-price">
                                {{toCurrency cart.totalCost site.currency language}} {{#if cart.oldTotalCost}}
                                <div class="cross">{{toCurrency cart.oldTotalCost site.currency language}}</div>{{/if}}
                            </div>
                            <div>
                                {{message "cms_cart_total"}} {{#if cart.discounts}}<br>
                                <span class="label label-default" title="{{#cart.discounts}} {{.}} {{/cart.discounts}}" data-toggle="tooltip"><small>{{message "cms_cart_promotion"}}</small></span> {{/if}}
                            </div>
                        </li>
                    </ul>
                    {{/if}}
                    <!-- CART MESSAGES -->
                    {{#if cart.messages}} {{#ifequal cart.cartLocation "MENU"}} {{#ifequal cart.deliveryType "DELIVERY"}} {{#ifequal cart.deliveryStatus "NOT_DELIVERY"}}{{else}}
                    ...
                    <div class="alert alert-danger _cart-errors">
                        {{#ifequal cart.errors.length 1}} {{#cart.errors}} {{{.}}} {{/cart.errors}} {{else}}
                    ...
                    {{/if}} {{#ifequal cart.deliveryType "DELIVERY"}} {{#ifequal cart.deliveryStatus "NO_ADDRESS"}}
                ...
                <div class="m-t-sm small text-center">
                    ...
                    <div class="clearfix theme-cart-min-order">
                        <div>
                            {{message "cms_cart_min_order"}} {{#if cart.deliveryType}} {{#ifequal cart.deliveryType "DELIVERY"}} {{#ifnull cart.minOrderDeliveryPrice}} {{toCurrency 0 site.currency language}} {{else}} {{toCurrency cart.minOrderDeliveryPrice site.currency language}}
                            {{#if cart.maxOrderDeliveryPrice}} - {{toCurrency cart.maxOrderDeliveryPrice site.currency language}} {{/if}} {{/ifnull}} {{/ifequal}} {{#ifequal cart.deliveryType "TAKEAWAY"}} {{#ifnull cart.minTakeAwayPrice}} {{toCurrency
                            0 site.currency language}} {{else}} {{toCurrency cart.minTakeAwayPrice site.currency language}} {{/ifnull}} {{/ifequal}} {{#ifequal cart.deliveryType "ONSITE"}} {{#ifnull cart.setMinOnSitePrice}} {{toCurrency 0 site.currency
                            language}} {{else}} {{toCurrency cart.minOnSitePrice site.currency language}} {{/ifnull}} {{/ifequal}} {{else}} {{#ifnull cart.minMinOrderPrice}} {{toCurrency 0 site.currency language}} {{else}} {{toCurrency cart.minMinOrderPrice
                            site.currency language}} {{/ifnull}} {{#ifnull cart.maxMinOrderPrice}} {{else}} {{#ifnull cart.minMinOrderPrice}} {{else}} - {{/ifnull}} {{toCurrency cart.maxMinOrderPrice site.currency language}} {{/ifnull}} {{/if}} {{#moreThanOneNotNull
                            cart.minOnSitePrice cart.minTakeAwayPrice cart.minOrderDeliveryPrice}}
                            <i class="fa fa-info-circle" data-container="body" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-html="true" data-content='
                            ...
                            '></i> {{/moreThanOneNotNull}}
                        </div>
                    </div>
                    <!-- MIN ORDER -->
                    <!-- COUPONS -->
                    <div class="clearfix theme-cart-coupons m-t-xs">
                        {{#if cart.coupons}} {{message "cms_cart_coupons"}}
                        <br/> {{#cart.coupons}} {{.}} <a href="index.html#" class="_remove-coupon-from-cart cart-icon btn plus theme-plus" data-coupon-code="{{.}}">−</a><br/> {{/cart.coupons}} {{/if}} {{#ifequal cart.couponVisibilityType 'ONE_COUPON'}}
                        {{#if cart.coupons}}{{else}}
                        <a href="index.html#" class="_show-coupon-code-form">{{message "cms_cart_coupon_btn"}} </a> {{/if}} {{/ifequal}} {{#ifequal cart.couponVisibilityType 'MANY_COUPONS'}}
                        <a href="index.html#" class="_show-coupon-code-form">{{message "cms_cart_coupon_btn"}} </a> {{/ifequal}}
                    </div>
                    <!-- COUPONS -->
                </div>
            </div>
                        ...
                        <table class="table">
                            ...
                            <tr>
								...
								{{#if oldPrice}} <br><span class="label label-default" title="{{#discounts}} {{.}} {{/discounts}}" data-toggle="tooltip"><small>{{#compare price oldPrice operator="<="}} {{message "cms_cart_promotion"}} {{else}} {{message "cms_cart_fee"}} {{/compare}}</small></span>                                    {{/if}}
                                    ...
                                    <div class="addon">
                                        {{#addons}} {{#if quantity}} {{#if defaultQuantity}} {{else}}
                                        <p>+ {{toQty quantity}} x {{name}} ( {{toCurrency price ../../site.currency @root.language}} {{#if oldPrice}}
                                            <span class="cross" title="{{#discounts}} {{.}} {{/discounts}}" data-toggle="tooltip" style="float: none;">{{toCurrency oldPrice ../../site.currency language}}</span> {{/if}} )
                                        </p>
                                        {{/if}} {{else}}
                                        <p class="cross">+ {{defaultQuantity}} x {{name}} ( {{toCurrency price ../../site.currency @root.language}} )
                                        </p>
                                        {{/if}} {{/addons}}
                                    </div>
                                    {{#if relatedNumber}}
                                ...
                                <td>
                                    <div class="pull-right">
                                        ...
                                        <div>
                                            <a href="index.html#" id="{{id}}" data-pid="{{productPriceId}}" data-product-id="{{productId}}" class="increase-cart-item cart-icon btn plus theme-plus">+</a>
                                            <a href="index.html#" id="{{id}}" data-pid="{{productPriceId}}" data-product-id="{{productId}}" class="decrease-cart-item cart-icon btn plus theme-plus">−</a>
                            ...
                            <tr class="theme-cart-min-order">
                                ...
                                <td>
                                    <div class="price pull-right">
                                        {{#ifnull cart.minMinOrderPrice}} {{toCurrency 0 site.currency language}} {{else}} {{toCurrency cart.minMinOrderPrice site.currency language}} {{/ifnull}} {{#ifnull cart.maxMinOrderPrice}} {{else}} {{#ifnull cart.minMinOrderPrice}} {{else}} - {{/ifnull}}
                                        {{toCurrency cart.maxMinOrderPrice site.currency language}} {{/ifnull}}
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    {{message "cms_cart_delivery"}} {{#ifnull cart.oldDeliveryCost}} {{else}}<br><span class="label label-default" data-toggle="tooltip"><small>{{#compare cart.deliveryCost cart.oldDeliveryCost operator="<="}} {{message "cms_cart_promotion"}} {{else}} {{message "cms_cart_fee"}} {{/compare}}</small></span>                                    {{/ifnull}} {{#ifequal cart.deliveryStatus "NO_ADDRESS"}}
                                    <span class="help-block">{{message "cms_cart_delivery_not_set"}}</span> {{/ifequal}}
                                </td>
                                <td width="100">
                                    <div class="pull-right price">
                                        {{#ifequal cart.deliveryStatus "DELIVERY"}} {{toCurrency cart.deliveryCost site.currency language}} {{else}} {{#ifnull cart.minDeliveryCost}} {{else}} {{toCurrency cart.minDeliveryCost site.currency language}} {{/ifnull}} {{#ifnull cart.maxDeliveryCost}}
                                        {{else}} {{#ifnull cart.minDeliveryCost}} {{else}} - {{/ifnull}} {{toCurrency cart.maxDeliveryCost site.currency language}} {{/ifnull}} {{/ifequal}} {{#ifnull cart.oldDeliveryCost}} {{else}}
                                        <div class="cross">{{toCurrency cart.oldDeliveryCost site.currency language}}</div>{{/ifnull}}
                                    </div>
                                </td>
                            </tr>
                            {{/if}} {{#if cart.packageCost}}
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="pull-right price">
                                        {{toCurrency cart.packageCost site.currency language}} {{#if cart.oldPackageCost}}
                                        <div class="cross">{{toCurrency cart.oldPackageCost site.currency language}}</div>{{/if}}
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    {{message "cms_cart_total"}} {{#if cart.discounts}} <br><span class="label label-default" title="{{#cart.discounts}} {{.}} {{/cart.discounts}}" data-toggle="tooltip"><small>{{message "cms_cart_promotion"}}</small></span>                                    {{/if}}
                                </td>
                                <td>
                                    <div class="pull-right price">
                                        {{#if cart.totalCost}} {{toCurrency cart.totalCost site.currency language}} {{else}} {{toCurrency 0 site.currency language}} {{/if}} {{#if cart.oldTotalCost}}
                                        <div class="cross">{{toCurrency cart.oldTotalCost site.currency language}}</div>{{/if}}
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <br/> {{#cart.coupons}} {{.}} <a href="index.html#" class="_remove-coupon-from-cart text-u-l" data-coupon-code="{{.}}">{{message "cms_cart_coupon_remove"}}</a><br/> {{/cart.coupons}}
                                </td>
                            </tr>
                            {{/if}}
                            <tr>
            ...
            <div class="_cart-mini-content" style="display: none;">
                ...
                <div class="cart-mini-nav _cart-mini-nav" style="display: none;">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="index.html#" class="_start-order {{#if editMode}}disabled{{/if}} btn btn-block btn-upmenu m-t">
								{{message "cms_cart_order_btn"}}
			 			</a>
                        </li>
                        <li>
                        ...
                        <li class="theme-cart-coupon-btn">
                            {{#ifequal cart.couponVisibilityType 'ONE_COUPON'}} {{#if cart.coupons}}{{else}}
                            <a href="index.html#" class="_show-coupon-code-form">{{message "cms_cart_coupon_btn"}} </a> {{/if}} {{/ifequal}} {{#ifequal cart.couponVisibilityType 'MANY_COUPONS'}}
                            <a href="index.html#" class="_show-coupon-code-form">{{message "cms_cart_coupon_btn"}} </a> {{/ifequal}}
                        </li>
                        <li>
                            <a href="index.html#" class="_show-cart-details">{{message "cms_cart_mobile_orderDetails"}} </a>
                        </li>
                        {{#if restaurant.delivery}}
                        <li>
                            <a href="index.html#" class="_start-check-delivery">{{message "cms_cart_mobile_checkIfDelivery"}} </a>
                        </li>
                        {{/if}} {{#if customer.registered}}
                        <li><a href="index.html#" id="_start-edit-customer">{{message "cms_cart_account"}}</a></li>
                        <li><a href="index.html#" id="_start-logout">{{message "cms_cart_logout"}}</a></li>
                        {{else}}
                        <li><a href="https://avocado-en.orderwebsite.com/?login" id="_start-login">{{message "cms_cart_login"}}</a></li>
            ...
            <div class="mobile-cart-container">
                <header class="modal-header">
                    <h3 class="modal-title">
                        <div class="pull-right pointer _mobile-cart-details">
                            <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/x.svg" class="m-t-n-3xxs">
                        </div>
                    ...
                    <div class="col-sm-12 _cart-details">
                        <div class="cart">
                                    ...
                                    <div class="pull-right">
                                        <div>
                                            ...
                                            <div class="clearfix mobile-summary-amount m-t-sm">
                                                ...
                                                <a href="index.html#" id="{{id}}" data-pid="{{productPriceId}}" data-product-id="{{productId}}" class="decrease-cart-item cart-icon btn plus theme-plus pull-right">−</a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <ul class="list-unstyled cart-summary">
                                ...
                                <!-- Delivery Cost -->
                                {{#if restaurant.delivery}} {{#ifequal cart.deliveryType "DELIVERY"}}
                                <li class="clearfix">
                                    <div class="pull-right price text-right">
                                        {{#ifequal cart.deliveryStatus "DELIVERY"}} {{#ifequal cart.deliveryCost 0}} {{message "cms_cart_freeDelivery"}} {{else}} {{toCurrency cart.deliveryCost site.currency language}} {{/ifequal}} {{else}} {{#ifnull cart.minDeliveryCost}} {{else}} {{toCurrency
                                        cart.minDeliveryCost site.currency language}} {{/ifnull}} {{#ifnull cart.maxDeliveryCost}} {{else}} {{#ifequal cart.maxDeliveryCost 0}} {{message "cms_cart_freeDelivery"}} {{else}} {{#ifnull cart.minDeliveryCost}}
                                        {{else}} - {{/ifnull}} {{toCurrency cart.maxDeliveryCost site.currency language}} {{/ifequal}} {{/ifnull}} {{/ifequal}} {{#ifnull cart.oldDeliveryCost}} {{else}}
                                        <div class="cross">{{toCurrency cart.oldDeliveryCost site.currency language}}</div>{{/ifnull}}
                                    </div>
                                    <div>
                                        {{message "cms_cart_delivery"}} {{#ifnull cart.oldDeliveryCost}} {{else}}<br><span class="label label-default" data-toggle="tooltip"><small>{{#compare cart.deliveryCost cart.oldDeliveryCost operator="<="}} {{message "cms_cart_promotion"}} {{else}} {{message "cms_cart_fee"}} {{/compare}}</small></span>                                        {{/ifnull}} {{#ifequal cart.deliveryStatus "NO_ADDRESS"}}
                                ...
                                {{/cart.processingFees}} {{/if}} {{#if cart.tax}} {{#each cart.tax.taxes}}
                                <li class="clearfix">
                                    <div class="pull-right price">
                                        {{toCurrency amount site.currency language}}
                                    </div>
                                ...
                                <li class="clearfix theme-cart-tips">
                                    ...
                                    <div class="btn-group d-flex {{#if cart.tipRequired}} radio-btns {{/if}} media-flex m-t-xs" role="group" aria-label="...">
                                        {{#restaurant.tipPercentage}} {{#if ../cart.tipRequired}}
                                        <label class="btn btn-default flex-fill single-tip _set-tip radio-single
                                                {{#ifequal ../cart.tipType " PERCENT "}}{{#ifequal ../cart.tip .}}selected{{/ifequal}}{{/ifequal}}" for="tip{{.}}" data-tip="{{.}}" data-tipType="PERCENT">{{.}}%</label>
                                        <input type="radio" class="btn-check hidden" name="tip" id="tip{{.}}" autocomplete="off" {{#ifequal ../cart.tipType "PERCENT"}} {{#ifequal ../cart.tip .}}checked{{/ifequal}} {{/ifequal}}> {{else}}
                                        <button type="button" class="btn btn-default flex-fill _set-tip
                                            {{#ifequal ../cart.tipType " PERCENT "}}
                                                    {{#ifequal ../cart.tip .}}selected{{/ifequal}}
                                                {{/ifequal}}" data-tip="{{.}}" data-tipType="PERCENT">
                                ...
                                <li class="clearfix total theme-cart-total">
                                    <div class="pull-right price total-price">
                                        {{toCurrency cart.totalCost site.currency language}} {{#if cart.totalCostWithoutCartDiscount}}
                                ...
                                {{/if}} {{#ifequal cart.couponVisibilityType 'ONE_COUPON'}} {{#if cart.coupons}}{{else}}
                                <li class="theme-cart-coupon-btn">
                                    <a href="index.html#" class="_show-coupon-code-form">{{message "cms_cart_coupon_btn"}} </a>
                                </li>
                                {{/if}} {{/ifequal}} {{#ifequal cart.couponVisibilityType 'MANY_COUPONS'}}
                                <li class="theme-cart-coupon-btn">
                                    <a href="index.html#" class="_show-coupon-code-form text-u-l">{{message "cms_cart_coupon_btn"}} </a>
                                </li>
                                {{/ifequal}} {{#if cart.errors}}
                                <li class="clearfix">
                                    <div>
                                        <div class="alert alert-danger _mobile-cart-errors" style="margin-top: 15px; margin-bottom: 0px;">
                                            {{#cart.errors}} {{.}} {{/cart.errors}}
                            ...
                            {{/ifequal}} {{/if}} {{/if}}
                            <!-- CART MESSAGES -->
                            {{#if cart.messages}} {{#ifequal cart.deliveryStatus "NOT_DELIVERY"}} {{else}}
                            <div class="alert alert-warning">
                                {{#cart.messages}} {{{.}}} {{/cart.messages}}
                            </div>
                            {{/ifequal}} {{/if}}
                ...
                <footer>
                    <div class="col-sm-12 btn-flex">
                        <a href="index.html#" class="btn btn-upmenu btn-block btn-lg {{#if cart.items}}{{else}}disabled{{/if}} _start-order {{#if editMode}}disabled{{/if}}">
                    {{message "cms_cart_order_btn"}} <i class="fa fa-angle-right v-middle m-t-n-3xxs"></i>
                </a>
                    </div>
                </footer>
        ...
        <div class="mobile-restaurant-details hidden-sm hidden-md hidden-lg">
            <ul class="list-unstyled">
                ...
                <li>
                    <div class="dropdown">
                        <a href="index.html#" class="dropdown-toggle flex" data-toggle="dropdown">
                        ...
                        </svg> {{site.currentLanguage.name}}
                            <i class="fa fa-fw fa-angle-down"></i>
                        </a>
                        <ul id="_cart_language" class="dropdown-menu dropdown-top left-side">
                            {{#site.languages}} {{#if url}}
                            <li>
                                <a href="https://avocado-en.orderwebsite.com/{{url}}">{{name}}</a>
                            </li>
                            {{/if}} {{/site.languages}}
                        </ul>
                    </div>
                </li>
                {{/ifequal}} {{#if tableNumber}}
                <li>
                    <a href="index.html#" class="_restaurant-info">
                ...
                <li>
                    <a href="index.html#" id="_start-edit-customer">
                        <svg width="17" height="16" viewBox="0 0 17 16" stroke="currentColor" class="pull-left inline" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="index.html#" id="_start-logout">
                ...
                <li>
                    <a href="index.html#" class="_mobile-cart-details">
                        <svg width="17" height="16" viewBox="0 0 17 16" stroke="currentColor" class="pull-left inline" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="_shopping-cart-container" id="_shopping-cart">
            ...
            <div class="_mobile-cart cart visible-xs">
                <a href="index.html#" class="btn btn-upmenu btn-lg btn-block disabled" disabled>
            {{message "cms_cart_order_btn"}}
        ...
        <div class="cart-wrapper m-b cart-delivery-types {{#if cmsv4}}cmsv4{{/if}}">
            <div class="theme-context-wrapper">
                <div class="btn-group theme-cart-delivery-type">
                    ...
                    <ul class="dropdown-menu dropdown-select">
                        ...
                        <li class="{{#ifequal id ../customer.deliveryType}} active {{/ifequal}}">
                            <a href="index.html#" data-delivery-type-id="{{id}}">
                ...
                <p class="small m-b-none m-t-sm _cart-delivery-address" {{#ifequal cart.deliveryType "DELIVERY"}}{{else}}style="display: none;" {{/ifequal}}>
                    <i class="fa fa-map-marker"></i>&nbsp; {{#ifequal cart.deliveryStatus "NO_ADDRESS"}}
                    <a href="index.html#" class="_start-check-delivery text-ellipsis text-u-l pull-right">{{message "cms_restaurant_info_add_address"}}</a> {{else}}
                    <a href="index.html#" class="_start-check-delivery text-ellipsis pull-right">{{customer.street}}&nbsp;{{customer.streetNumber}}</a> {{/ifequal}}
                </p>
                {{#ifequal cart.deliveryType "DELIVERY"}} {{#ifequal cart.deliveryStatus "NO_ADDRESS"}} {{else}} {{#ifequal cart.deliveryStatus "NOT_DELIVERY"}}
                <div class="alert alert-warning m-t">{{message "cms_cart_notDeliveryToYou"}}</div>
                {{/ifequal}} {{#ifequal cart.deliveryStatus "NOT_AVAILABLE_NOW"}} {{#if cart.deliveryAreaAvailableHours}}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group {{#errors}} {{#ifequal field " code "}}has-error{{/ifequal}}{{/errors}}">
                            ...
                            <input type="text" name="code" value="{{code}}" class="form-control form-modal" placeholder="{{message " cms_coupon_form_code "}}" /> {{#errors}} {{#ifequal field "code"}}
                            <div class="help-block">{{error}}</div>{{/ifequal}} {{/errors}}
                        </div>
                    </div>
                </div>
...
<div class="modal-body">
            <div class="modal-header">
                ...
                <a href="index.html#!" class="btn btn-lg _order-form-cancel" data-dismiss="modal">
                    <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/x.svg">
                </a>
            </div>
            <div class="container fluid-container">
                <div class="row">
                    <form action="index.html#" id="order-form">
                        <div class="col-md-8 col-lg-7">
                            ...
                            <div class="row">
                                <div class="col-sm-12" id="_order-form-errors">
                                    <div class="alert alert-danger">
                                        ...
                                        {{#errors}} {{#ifequal field "restaurantId"}}
                                        <p>{{{error}}}</p>{{/ifequal}} {{/errors}} {{/if}}
                                    </div>
                                </div>
                            </div>
                            {{/if}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 m-b">
                                        <div class="form-group m-b-none {{#errors}} {{#ifequal field " paymentType "}}has-error{{/ifequal}}{{/errors}}">
                                            ...
                                            {{#ifequal restaurant.id "dabc5ad1-d0a4-11e6-93f9-525400841de1" "3333335a-b644-11e6-9d08-525400841de1"}} {{#if settings.cash}}
                                            <div class="btn-radio">
                                                ...
                                                <div class="btn-payment" id="payment-type-cash">
                                                    ...
                                                    <div class="payment-logo">
                                                        <img src="https://avocado-en.orderwebsite.com/{{{static_url}}}/images/admin/orderForm/order-cash.png" style="width: 38px; margin-top: -1px; height: auto;"/>
                                                    </div>
                                                </div>
											</label>
                                            </div>
                                            {{/if}} {{/ifequal}} {{#if settings.online}} {{#restaurant.onlinePaymentTypes}}
                                            <input type="radio" class="hidden" name="paymentProviderType" value="{{paymentProviderType}}" {{#ifequal ../paymentType "ONLINE"}} {{#if ../paymentProviderType}} {{#ifequal ../paymentProviderType paymentProviderType}} checked="checked" {{/ifequal}} {{else}}
                                                {{#ifequal @index "0"}} checked="checked" {{/ifequal}} {{/if}} {{/ifequal}} />
                                            <div class="btn-radio">
                                                <label class="control-label">
                                                        ...
                                                        <div class="payment-label">
                                                            {{#ifequal paymentProviderType "STRIPE" "STRIPE_CONNECT"}}
                                                                <div class="payment-provider-logo">
                                                                    <img src="https://avocado-en.orderwebsite.com/{{{../static_url}}}/images/admin/orderForm/payment-provider-stripe.png" style="margin-top: -3px;" />
                                                                </div>
                                                            {{/ifequal}}
                                                            {{#ifequal paymentProviderType "ADYEN"}}
                                                                <div class="payment-provider-logo">
                                                                    <img src="https://avocado-en.orderwebsite.com/{{{../static_url}}}/images/admin/orderForm/payment-provider-adyen.png" style="height: 23px; margin-top: -1px;" />
                                                                </div>
                                                            {{/ifequal}}
                                                            {{#ifequal paymentProviderType "PAYPAL"}}
                                                                <div class="payment-provider-logo">
                                                                    <img src="https://avocado-en.orderwebsite.com/{{{../static_url}}}/images/admin/orderForm/payment-provider-paypal.png" style="height: 24px; margin-top: -1px;" />
                                                                </div>
                                                                <p class="m-t m-b-none">{{{message "cms_order_payment_redirect_info" "PayPal"}}}</p>
                                                            {{/ifequal}}
                                                            {{#ifequal paymentProviderType "PAYU" "PAYU_LOCAL"}}
                                                                <div class="payment-provider-logo">
                                                                    <img src="https://avocado-en.orderwebsite.com/{{{../static_url}}}/images/admin/orderForm/payment-provider-payu.png" style="height: 24px; margin-top: -4px;" />
                                                                </div>
                                                                <p class="m-t m-b-none">{{{message "cms_order_payment_redirect_info" "PayU"}}}</p>
                                                            {{/ifequal}}
                                                            {{#ifequal paymentProviderType "TPAY"}}
                                                                <div class="payment-provider-logo">
                                                                    <img src="https://avocado-en.orderwebsite.com/{{{../static_url}}}/images/logos/tpay-logo.png"/>
                                                                </div>
                                                                ...
                                                                <div class="payment-logo-methods">
                                                                    {{#methods}}
                                                                        {{#compare @index 2 operator="<="}}
                                                                            ...
                                                                            <img src="https://avocado-en.orderwebsite.com/{{iconUrl}}" class="provider-small-logo" alt="{{name}}" />
                                                                        </span>
                                                                        {{/compare}}
                                                                    {{/methods}}
                                                                    {{#if moreThan3Methods}}
                                            ...
                                            {{/restaurant.onlinePaymentTypes}} {{/if}} {{#if settings.card}}
                                            <div class="btn-radio">
                                                <label class="control-label">
                                            ...
                                            <div class="btn-payment" id="payment-type-card">
                                                ...
                                                <div class="payment-logo">
                                                    <img src="https://avocado-en.orderwebsite.com/{{{static_url}}}/images/admin/orderForm/order-card.png" style="width: 38px; margin-top: -4px; height: auto;"/>
                                                </div>
                                            </div>
										</label>
                                            </div>
                                            {{/if}} {{#ifequal restaurant.id "dabc5ad1-d0a4-11e6-93f9-525400841de1" "3333335a-b644-11e6-9d08-525400841de1"}} {{else}} {{#if settings.cash}}
                                            <div class="btn-radio">
                                                <label class="control-label">
												<input type="radio" class="hidden" name="paymentType" value="CASH" {{#ifequal paymentType "CASH"}}checked="checked"{{/ifequal}} />
                                                <div class="btn-payment" id="payment-type-cash">
                                            ...
                                            {{/if}} {{/ifequal}} {{#errors}} {{#ifequal field "paymentType"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                    <!-- PAYMENT TYPES -->
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group m-b-none {{#errors}} {{#ifequal field " deliveryType "}}has-error{{/ifequal}}{{/errors}}">
                                            ...
                                            {{/settings.deliveryTypes}} {{#errors}} {{#ifequal field "deliveryType"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                    <!-- DELIVERY TYPES -->
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group m-b-none {{#errors}} {{#ifequal field " deliveryDate "}}has-error{{/ifequal}}{{/errors}}">
                                            ...
                                            {{/if}} {{#errors}} {{#ifequal field "deliveryDate"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                    <!-- DELIVERY DATE -->
                            ...
                            <section class="bg-white wrapper _order-address-group" {{#ifequal deliveryType "TAKEAWAY" "ONSITE"}} style="display:none;" {{/ifequal}}>
                                <div class="row m-b-sm">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="m-t-sm pull-right">
                                            <a href="index.html#!" class="btn _get-gps-location">
                                                <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/spinners/spinner-small.gif" alt="">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" name="longitude" value="{{longitude}}" id="longitude" /> {{#each settings.addressFields}}
                                    <div class="col-lg-{{largeWidth}} col-md-{{mediumWidth}} col-xs-{{smallWidth}}">
                                        <div class="form-group {{#each ../errors}} {{#ifequal field ../name}}has-error{{/ifequal}} {{/each}}">
                                            ...
                                            <input type="text" name="{{name}}" id="order-form-{{name}}" value="{{#ifequal name " street "}}{{../street}}{{/ifequal}}{{#ifequal name "streetNumber "}}{{../streetNumber}}{{/ifequal}}{{#ifequal name "city "}}{{../city}}{{/ifequal}}{{#ifequal name "postalCode
                                                "}}{{../postalCode}}{{/ifequal}}{{#ifequal name "region "}}{{../region}}{{/ifequal}}{{#ifequal name "apartmentNumber "}}{{../apartmentNumber}}{{/ifequal}}{{#ifequal name "floorNumber "}}{{../floorNumber}}{{/ifequal}}{{#ifequal name "customAddressField1Value
                                                "}}{{../customAddressField1Value}}{{/ifequal}}{{#ifequal name "customAddressField2Value "}}{{../customAddressField2Value}}{{/ifequal}}{{#ifequal name "customAddressField3Value "}}{{../customAddressField3Value}}{{/ifequal}}" class="form-control " placeholder="" />                                            {{/ifequal}} {{#ifequal type "SELECT"}}
                                            <label class="text-ellipsis">{{label}}{{#if required}} *{{/if}}</label>
										...
										{{/values}}
									</select> {{/ifequal}} {{#each ../errors}} {{#ifequal field ../name}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/each}}
                                        </div>
                                    </div>
                                    {{/each}}
                                </div>
                                {{#each settings.personalFields}} {{#ifequal name "company"}} {{#unless hidden}}
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group {{#each ../errors}} {{#ifequal field " companyName "}}has-error{{/ifequal}}{{/each}}">
                                            ...
                                            <input type="text" name="companyName" value="{{../companyName}}" id="companyName" class="form-control" placeholder="" /> {{#each ../errors}} {{#ifequal field "companyName"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/each}}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section class="bg-white wrapper">
                                ...
                                <div class="row customer-row" id="customer-row">
                                    {{#each settings.personalFields}} {{#ifequal name "firstName" "lastName"}} {{#unless hidden}}
                                    <div class="col-sm-6">
                                        <div class="form-group {{#each ../errors}} {{#ifequal field ../name}}has-error{{/ifequal}} {{/each}}">
                                            <label>
                                            ...
                                            <input type="text" name="{{name}}" value="{{#ifequal name " firstName "}}{{../firstName}}{{/ifequal}}{{#ifequal name "lastName "}}{{../lastName}}{{/ifequal}}" class="form-control " placeholder="" /> {{#each
                                            ../errors}} {{#ifequal field ../name}}
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group {{#errors}} {{#ifequal field " phone "}}has-error{{/ifequal}}{{/errors}}">
                                            ...
                                            <input type="tel" name="phone" value="{{phone}}" data-phone="{{phone}}" class="form-control decimal-only" data-precision="0" data-additional-allowed-characters="- " placeholder="" /> {{#errors}} {{#ifequal field
                                            "phone"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                    {{#if customer.registered}} {{else}}
                                    <div class="col-sm-6">
                                        ...
                                        {{message "cms_order_email"}} *
                                            ...
                                            <input type="text" name="email" value="{{email}}" class="form-control " id="_customer_email" placeholder="" /> {{#errors}} {{#ifequal field "email"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                    {{/if}}
                                ...
                                <div class="row" id="reservation-people">
									...
									</select> {{#errors}} {{#ifequal field "people"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                </div>
                                {{#settings.deliveryTypes}} {{#ifequal id "TABLE_ORDER"}}
                                <div class="row table-number">
                                    <div class="col-sm-6">
                                        <div class="form-group {{#errors}} {{#ifequal field " tableNumber "}}has-error{{/ifequal}}{{/errors}}">
                                            ...
                                            <input name="tableNumber" class="form-control " type="text" placeholder="{{message " cms_order_tableNumber "}} *" readonly value="{{../tableNumber}}" /> {{#errors}} {{#ifequal field "tableNumber"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                </div>
                                {{/ifequal}} {{/settings.deliveryTypes}} {{#if settings.customField1}}
                                <div class="row" id="_custom-field1" style="display: none" data-types="{{settings.customField1.deliveryTypes}}">
                                    <div class="col-sm-6" id="customField1">
                                        <div class="form-group {{#errors}} {{#ifequal field " customField1Value "}}has-error{{/ifequal}}{{/errors}}">
                                            ...
                                            <input type="text" name="customField1Value" value="{{customField1Value}}" class="form-control" /> {{/ifequal}} {{#ifequal settings.customField1.type "SELECT"}}
                                            <label class="text-ellipsis">{{settings.customField1.name}} {{#if settings.customField1.required}}*{{/if}}</label>
                                            ...
                                            {{/settings.customField1.values}}
                                        </select> {{/ifequal}} {{#errors}} {{#ifequal field "customField1Value"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                </div>
                                {{/if}} {{#if settings.customField2}}
                                <div class="row" id="_custom-field2" style="display: none" data-types="{{settings.customField2.deliveryTypes}}">
                                    <div class="col-sm-6" id="customField2">
                                        <div class="form-group {{#errors}} {{#ifequal field " customField2Value "}}has-error{{/ifequal}}{{/errors}}">
                                            ...
                                            <input type="text" name="customField2Value" value="{{customField2Value}}" class="form-control" /> {{/ifequal}} {{#ifequal settings.customField2.type "SELECT"}}
                                            <label class="text-ellipsis">{{settings.customField2.name}} {{#if settings.customField2.required}}*{{/if}}</label>
                                            ...
                                            {{/settings.customField2.values}}
                                        </select> {{/ifequal}} {{#errors}} {{#ifequal field "customField2Value"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                </div>
                                {{/if}} {{#if settings.customField3}}
                                <div class="row" id="_custom-field3" style="display: none" data-types="{{settings.customField3.deliveryTypes}}">
                                    <div class="col-sm-6" id="customField3">
                                        <div class="form-group {{#errors}} {{#ifequal field " customField3Value "}}has-error{{/ifequal}}{{/errors}}">
                                            ...
                                            <input type="text" name="customField3Value" value="{{customField3Value}}" class="form-control" /> {{/ifequal}} {{#ifequal settings.customField3.type "SELECT"}}
                                            <label class="text-ellipsis">{{settings.customField3.name}} {{#if settings.customField3.required}}*{{/if}}</label>
                                            ...
                                            {{/settings.customField3.values}}
                                        </select> {{/ifequal}} {{#errors}} {{#ifequal field "customField3Value"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                </div>
                                {{/if}} {{#if settings.invoice}}
                                <div class="row">
                                    <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            {{message "cms_order_invoiceTaxId"}} *
                                                ...
                                                <input type="text" name="invoiceTaxId" value="{{invoiceTaxId}}" id="invoiceTaxId" class="form-control" /> {{#errors}} {{#ifequal field "invoiceTaxId"}}
                                                <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            {{message "cms_order_invoiceCompanyName"}} *
                                                ...
                                                <input type="text" name="invoiceCompanyName" value="{{invoiceCompanyName}}" id="invoiceCompanyName" class="form-control" /> {{#errors}} {{#ifequal field "invoiceCompanyName"}}
                                                <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            {{message "cms_order_street"}} *
                                                ...
                                                <input type="text" name="invoiceStreet" value="{{invoiceStreet}}" class="form-control" /> {{#errors}} {{#ifequal field "invoiceStreet"}}
                                                <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-3">
                                            ...
                                            {{message "cms_order_streetNumber"}}
                                                ...
                                                <input type="text" name="invoiceStreetNumber" value="{{invoiceStreetNumber}}" class="form-control" /> {{#errors}} {{#ifequal field "invoiceStreetNumber"}}
                                                <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-3">
                                            ...
                                            {{message "cms_order_apartmentNumber"}}
                                                ...
                                                <input type="text" name="invoiceApartmentNumber" value="{{invoiceApartmentNumber}}" class="form-control" /> {{#errors}} {{#ifequal field "invoiceApartmentNumber"}}
                                                <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-8 col-sm-8">
                                            ...
                                            {{message "cms_order_city"}} *
                                                ...
                                                <input type="text" name="invoiceCity" value="{{invoiceCity}}" class="form-control" /> {{#errors}} {{#ifequal field "invoiceCity"}}
                                                <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                            </div>
                                        </div>
                                        <div class="col-xs-4 col-sm-4">
                                            ...
                                            {{message "cms_order_postalCode"}}
                                                ...
                                                <input type="text" name="invoicePostalCode" value="{{invoicePostalCode}}" class="form-control" /> {{#errors}} {{#ifequal field "invoicePostalCode"}}
                                                <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            {{message "cms_order_country"}} *
                                                ...
                                                <input type="text" name="invoiceCountry" value="{{invoiceCountry}}" class="form-control" /> {{#errors}} {{#ifequal field "invoiceCountry"}}
                                                <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                {{/if}} {{#each settings.personalFields}} {{#ifequal name "comments"}} {{#unless hidden}}
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group m-b-xs {{#each ../errors}} {{#ifequal field " comment "}}has-error{{/ifequal}}{{/each}}">
                                            <a href="index.html#!" class="_show-order-comment">
                                                <i class="fa fa-plus-circle"></i>&nbsp;{{message "cms_order_add_comment"}}
                                            </a>
                                            <textarea name="comment" class="form-control m-t-xs order-comment" rows="2" placeholder="" style="{{#if ../comment}}{{else}}display: none;{{/if}}">{{../comment}}</textarea> {{#each ../errors}} {{#ifequal field
                                            "comment"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/each}}
                                        </div>
                                    </div>
                            ...
                            <section class="{{#ifequal deliveryType " TABLE_ORDER "}}{{else}}bg-white wrapper{{/ifequal}}">
                                {{#if customer.registered}} {{else}} {{#ifequal deliveryType "TABLE_ORDER"}}{{else}}
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="checkbox">
                                            <label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group {{#errors}} {{#ifequal field " customerPassword "}}has-error{{/ifequal}}{{/errors}}">
                                            <input type="password" name="customerPassword" value="{{customerPassword}}" class="form-control" placeholder="{{message " cms_order_customerPassword "}} *" data-toggle="tooltip" data-placement="bottom" title="{{message " cms_order_registrationEmailConfirmInformation
                                                "}}"/> {{#errors}} {{#ifequal field "customerPassword"}}
                                            <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group {{#errors}} {{#ifequal field " customerPasswordConfirm "}}has-error{{/ifequal}}{{/errors}}">
                                            <input type="password" name="customerPasswordConfirm" value="{{customerPasswordConfirm}}" class="form-control " placeholder="{{message " cms_order_customerPasswordConfirm "}} *" /> {{#errors}} {{#ifequal field
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        {{#if settings.termsOfServiceUrl}}
                                            <a href="https://avocado-en.orderwebsite.com/{{{settings.termsOfServiceUrl}}}" target="_blank">{{message "cms_order_termsOfServiceUrl"}}</a>
                                        {{else}}
                                            {{#if settings.termsOfServiceContent}}
                                                <a href="index.html#" id="_show-terms-of-service">{{message "cms_order_termsOfServiceUrl"}}</a>
                                            {{/if}}
                                        {{/if}}
                                    ...
                                    {{/moreThanOneNotNull}}
                                        {{#if settings.privacyPolicyUrl}}
                                            <a href="https://avocado-en.orderwebsite.com/{{{settings.privacyPolicyUrl}}}" target="_blank">{{message "cms_order_privacyPolicyUrl"}}</a>
                                        {{else}}
                                            {{#if settings.privacyPolicyContent}}
                                                <a href="index.html#" id="_show-privacy-policy">{{message "cms_order_privacyPolicyUrl"}}</a>
                                            {{/if}}
                                        {{/if}}
                                        ...
                                        {{/moreThanOneNotNull}} {{#if settings.adultTermsContent}}
                                        <div class="checkbox">
                                            <label>
                                    <input type="checkbox" value="true" name="adultTerms" {{#if adultTerms}} checked="checked" {{/if}} />
                                    {{message "cms_adult_regulations"}} <a href="index.html#" class="_show-adult-terms-modal">{{message "cms_adult_regulations_link"}}</a>
                                    {{message "cms_order_termsOfService_required"}}
                                    {{#errors}}
                                    ...
                                    {{/errors}}
                                        ...
                                        {{/if}} {{#ifequal deliveryType "TABLE_ORDER"}} {{else}}
                                        <input type="hidden" name="newsletterHidden" value="{{newsletterHidden}}" id="newsletterHidden" class="form-control" /> {{#unless newsletterHidden}}
                                        <div class="checkbox">
                                            <label>
                                            ...
                                            <span>{{message "cms_gdpr_order_form_email"}}
                                               {{#if settings.newsletterGdpr}}
                                                   <a href="index.html#" class="_show-newsletter-gdpr">
                        ...
                        <div class="col-md-4 col-md-offset-0 col-lg-4 col-lg-offset-1">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a href="index.html#" class="btn btn-block btn-lg btn-upmenu hidden-xs _order-form-submit" data-online-payment-title="{{message " cms_order_createOrderBtn_online_payment "}}" data-offline-payment-title="{{message " cms_order_createOrderBtn "}}">{{message "cms_order_createOrderBtn"}}</a>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="modal-footer visible-xs">
                <div class="proceed-box">
                    <a href="index.html#" class="btn btn-lg btn-upmenu btn-block _order-form-submit" data-online-payment-title="{{message " cms_order_createOrderBtn_online_payment "}}" data-offline-payment-title="{{message " cms_order_createOrderBtn "}}">{{message "cms_order_createOrderBtn"}}</a>
                </div>
            </div>
        </div>
        <script>
            ...
            <form id="delivery-check-form">
                <div class="row check-form-narrow">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="row">
                                {{#unless site.hideAddressSearchOnRestaurantList}} {{#if restaurantSearchForm.settings.deliveryEnabled}}
                                ...
                                <div class="check-form-group" style="display: none;">
                                    <div class="row">
                                        {{#if restaurantSearchForm}} {{#each restaurantSearchForm.settings.addressFields}}
                                        <div class="col-lg-{{largeWidth}} col-md-{{mediumWidth}} col-xs-{{smallWidth}}">
                                            <div class="form-group {{#each ../errors}} {{#ifequal field ../name}}has-error{{/ifequal}} {{/each}}">
                                                {{#ifequal type "TEXT"}}
                                                <input type="text" name="{{name}}" data-required="{{required}}" value="{{#ifequal name " street "}}{{../street}}{{/ifequal}}{{#ifequal name "streetNumber "}}{{../streetNumber}}{{/ifequal}}{{#ifequal name "city
                                                    "}}{{../city}}{{/ifequal}}{{#ifequal name "postalCode "}}{{../postalCode}}{{/ifequal}}{{#ifequal name "region "}}{{../region}}{{/ifequal}}{{#ifequal name "apartmentNumber "}}{{../apartmentNumber}}{{/ifequal}}{{#ifequal name "floorNumber
                                                    "}}{{../floorNumber}}{{/ifequal}}{{#ifequal name "customAddressField1Value "}}{{../customAddressField1Value}}{{/ifequal}}{{#ifequal name "customAddressField2Value "}}{{../customAddressField2Value}}{{/ifequal}}{{#ifequal name "customAddressField3Value
                                                    "}}{{../customAddressField3Value}}{{/ifequal}}" id="{{name}}" class="form-control " placeholder="{{label}}{{#if required}} *{{/if}}" /> {{/ifequal}} {{#ifequal type "SELECT"}}
                ...
                <div class="row" id="_delivery-check-form-details">
                    <div class="col-sm-12">
                            ...
                            <div class="{{#ifequal theme_settings.delivery_check_form_type " simple-list " "box-images " "portal-boxes "}}col-sm-12{{else}}col-sm-6{{/ifequal}}">
                                <div class="search-holder {{#ifequal theme_settings.delivery_check_form_type " simple-list "}}check-form-narrow{{/ifequal}} {{#ifequal site.themeStoreType "PORTAL "}}types-container{{/ifequal}}">
                                    ...
                                    <div class="types-bar-holder">
                                        <div class="types-bar">
                                            <a href="index.html#" class="all selected">{{message "cms_restaurant_info_portal_all"}}</a> {{#kitchenTypes}}
                                            <a href="index.html#" class="index-{{@index}}">{{name}}</a> {{/kitchenTypes}} {{#compare kitchenTypes.length 8 operator=">"}}
                                            <a href="index.html#" class="show-more">{{message "cms_restaurant_info_portal_more"}} <i class="fa fa-fw fa-angle-down" aria-hidden="true"></i></a>
                                            <div class="more">
                                                <a href="index.html#" class="show-less">{{message "cms_restaurant_info_portal_less"}} <i class="fa fa-fw fa-angle-up" aria-hidden="true"></i></a>
                                            </div>
                                            {{/compare}}
                                        </div>
                                        <div class="search-bar m-b-md m-t-sm pull-right">
                                            <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/search.svg" class="search-icon">
                                    ...
                                    <div class="dropdown inline delivery-dropdown">
                                        {{#ifequal site.themeStoreType "PORTAL"}}
                                        <p>{{message "cms_restaurant_filter_portal"}}</p>{{/ifequal}}
                                    ...
                                    <span>{{message "cms_restaurant_filter_title"}}</span>&nbsp;<i class="fa fa-fw fa-angle-down"></i>
                                        ...
                                        <ul class="dropdown-menu dropdown-select">
                                            <li class="delivery-type-form" data-value="ALL">
                                                <a href="index.html#" class="reset-filter">
                                            ...
                                            <li class="">
                                                <a href="index.html#" class="delivery-type-form" data-value="DELIVERY">
                                            ...
                                            {{/if}}
                                            <li class="">
                                                <a href="index.html#" class="delivery-type-form" data-value="TAKEAWAY">
                                            ...
                                            <li class="">
                                                <a href="index.html#" class="delivery-type-form" data-value="ONSITE">
                        ...
                        <div class="row" {{#ifequal hideRestaurants "true"}}style="display: none;" {{/ifequal}}>
                         ...
                         {{#ifnull deliveryCost}} {{else}} _restaurant-delivery-ok {{/ifnull}} {{attributes.cssClass}}" id="_restaurant-{{id}}" data-id="{{id}}" data-takeaway="{{takeaway}}" data-delivery="{{delivery}}" data-onsite="{{onsite}}" data-lat="{{latitude}}"
                                    data-lng="{{longitude}}">
                                    <a href="https://avocado-en.orderwebsite.com/{{#if attributes.restaurantCustomUrl}}{{attributes.restaurantCustomUrl}}{{else}}{{url}}{{/if}}{{#if ../productId}}?pid={{../productId}}{{/if}}" class="restaurant-box-image" style="background-image: url(https://avocado-en.orderwebsite.com/{{attributes.restaurantImage_url_medium_url}}); ">
                            ...
                            <div class="row search-loader" style="display: none;">
                                <div class="col-sm-12 text-center m-t-lg m-b-lg">
                                    <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/spinners/oval-spinner.svg" alt="preloader spinner">
                                </div>
                            </div>
                            {{else}} {{#ifequal theme_settings.delivery_check_form_type "simple-list"}}
                            <div class="col-sm-12">
                                <div id="_delivery-check-restaurants" class="delivery-check-restaurants-simple-list check-form-narrow">
                                    <div class="restaurants-scrollable">
                                        <div class="list-group">
                                            {{#restaurants}}
                                            <a href="https://avocado-en.orderwebsite.com/{{#if attributes.restaurantCustomUrl}}{{attributes.restaurantCustomUrl}}{{else}}{{url}}{{/if}}{{#if ../productId}}?pid={{../productId}}{{/if}}" class="list-group-item _restaurant {{#ifnull deliveryCost}} {{else}} _restaurant-delivery-ok {{/ifnull}}
                                                   {{#if onlineOrderingEnabled}} theme-online-ordering {{/if}}
                                                   {{attributes.cssClass}} check-delivery-flex m-b
                                        " id="_restaurant-{{id}}" data-id="{{id}}" data-takeaway="{{takeaway}}" data-delivery="{{delivery}}" data-onsite="{{onsite}}" data-lat="{{latitude}}" data-lng="{{longitude}}">
                                                {{#if ../restaurantTemplate}}
                                                    {{{eval . value=../restaurantTemplate}}}
                                                {{else}}
                                ...
                                {{else}} {{#ifequal theme_settings.delivery_check_form_type "portal-boxes"}}
                                <div id="_delivery-check-restaurants" class="delivery-check-restaurants-portal-boxes">
                                    {{#restaurants}}
                                    <div class="col-md-4 col-sm-6 col-xs-12 m-b-30 _restaurant
                                                 {{#ifnull deliveryCost}} {{else}} _restaurant-delivery-ok {{/ifnull}} {{attributes.cssClass}}" id="_restaurant-{{id}}" data-id="{{id}}" data-takeaway="{{takeaway}}" data-delivery="{{delivery}}" data-onsite="{{onsite}}"
                                        data-lat="{{latitude}}" data-lng="{{longitude}}">
                                        <a href="https://avocado-en.orderwebsite.com/{{#if attributes.restaurantCustomUrl}}{{attributes.restaurantCustomUrl}}{{else}}{{url}}{{/if}}{{#if ../productId}}?pid={{../productId}}{{/if}}" class="restaurant-box-image" style="background-image: url(https://avocado-en.orderwebsite.com/{{attributes.restaurantImage_url}}); ">
                                                {{#if ../restaurantTemplate}}
                                                    {{{eval . value=../restaurantTemplate}}}
                                                {{else}}
                                                    ...
                                                    >
                                                        <div class='image-wrapper'>
                                                            <div class='restaurant-logo-wrapper lazy-image' data-src='{{#ifequal ../site.themeStoreType "PORTAL"}}{{logoImageUrl}}{{else}}{{attributes.restaurantImg_medium_url}}{{/ifequal}}' style='background-image: url(https://avocado-en.orderwebsite.com/{{site.assets_path}}/placeholder.jpg);'>
                ...
                <div class="container fluid-container">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            {{#ifequal status "NEW " "REJECTED " "ACCEPTED " "PREPARING " "PREPARED " "READY_TO_PICKUP " "READY_TO_CONSUMER_PICKUP " "IN_DELIVERY " "COMPLETED "}} done {{/ifequal}}" {{#if onlinePayment.type}}{{else}}style="display: none;"
                                    {{/if}}>
                                    <span>{{message "cms_order_step_payment"}}</span>
                                </li>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <section class="bg-white wrapper text-center cms-order-status new">
                            <div>
                                <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/hourglass.svg" alt="">
                        ...
                        {{/ifequal}} {{#ifequal status "REJECTED"}}
                        <section class="bg-white wrapper text-center cms-order-status rejected">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0">
                                    {{#ifequal type "RESERVATION"}}
                                    <div>
                                        <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/error.svg" alt="">
                                        <h3 class="cms-order-status-title">{{message "cms_reservation_rejected_title"}}</h3>
                                        <span class="text-muted">{{{statusDescription}}}</span>
                                    </div>
                                    {{else}}
                                    <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/themes/rejected-icon.png" alt="">
                                    <h3 class="reject-reason">
                                        {{{statusDescription}}}
                                    </h3>
                                    {{/ifequal}}
                                    <p class="alert alert-info alert-box m-b-none">
                                        {{message "cms_order_contactRestaurant"}} {{#if restaurant.phone}}
                                        <br>
                                        <i class="feather-icon icon-phone-call v-middle m-r-xs"></i>
                                        <a href="tel:{{restaurant.phone}}" class="no-wrap">{{restaurant.phone}}</a>{{#if restaurant.phone2}}, <a href="tel:{{restaurant.phone2}}" class="no-wrap">{{restaurant.phone2}}</a>{{/if}} {{#if restaurant.mobilePhone}}{{#if
                                        restaurant.phone}}, {{/if}}<a href="tel:{{restaurant.mobilePhone}}" class="no-wrap">{{restaurant.mobilePhone}}</a>{{/if}} {{/if}} {{#if restaurant.email}}
                                        <br>
                                        <i class="feather-icon icon-mail v-middle m-r-xs"></i>
                                        <a href="mailto:{{restaurant.email}}">{{restaurant.email}}</a> {{/if}}
                                    </p>
                                </div>
                            </div>
                        </section>
                        {{/ifequal}} {{#ifequal status "PAYMENT_IN_PROGRESS"}}
                        <section class="bg-white wrapper text-center cms-order-status new">
                            <div>
                                <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/hourglass.svg" alt="">
                        ...
                        {{/ifequal}} {{#ifequal status "PAYMENT_ERROR"}}
                        <section class="bg-white wrapper text-center cms-order-status rejected">
                            <div>
                                <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/error.svg" alt="">
                        ...
                        {{/ifequal}} {{#ifequal status "PAYMENT_CANCELED"}}
                        <section class="bg-white wrapper text-center cms-order-status rejected">
                            <div>
                                <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/error.svg" alt="">
                        ...
                        {{/ifequal}} {{#ifequal status "PAYMENT"}}
                        <section class="bg-white wrapper text-center cms-order-status payment">
                            <div>
                                ...
                                <a href="https://avocado-en.orderwebsite.com/{{onlinePayment.url}}" target="_blank" class="btn btn-success btn-lg _tpay-payment-btn">{{{message "cms_order_pay_online"}}}</a> {{/ifequal}}
                                <!-- TPAY -->
                                <!-- PAYU -->
                                {{#ifequal onlinePayment.type "PAYU" "PAYU_LOCAL"}}
                                <br>
                                <a href="https://avocado-en.orderwebsite.com/{{onlinePayment.url}}" class="btn btn-upmenu m-t-md _btn-online-payment" target="_blank">{{{message "cms_order_pay_online"}}} (payu)</a> {{/ifequal}}
                                <!-- PAYU -->
                                <!-- STRIPE -->
                        ...
                        {{/ifequal}} {{#ifequal status "ACCEPTED" "PREPARING" "PREPARED" "READY_TO_PICKUP" "READY_TO_CONSUMER_PICKUP" "IN_DELIVERY" "COMPLETED"}} {{#ifequal type "RESERVATION"}}
                        <section class="bg-white wrapper text-center cms-order-status rejected">
                            <div>
                                <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/success.svg" alt="">
                                <h3 class="cms-order-status-title">{{message "cms_reservation_accepted_title"}}</h3>
                                <span class="text-muted">{{{statusDescription}}}</span>
                            </div>
                        </section>
                        {{else}} {{#if externalSystemTrackingUrl}}
                        <section class="bg-white wrapper text-center cms-order-status rejected">
                            <div>
                                <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/success.svg" alt="">
                                <h3 class="cms-order-status-title">{{message "cms_order_status_processing_title"}}</h3>
                                <div class="order-tracking-url m-t-sm">
                                    <a href="https://avocado-en.orderwebsite.com/{{externalSystemTrackingUrl}}" target="_blank">
                        ...
                        {{else}} {{#if deliveryTime}} {{#ifequal status "ACCEPTED"}}
                        <section class="bg-white wrapper text-center cms-order-status">
                            <div>
                                <div class="status-countdown" id="_clock" style="margin-top: 0 !important;">
                                    <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/spinners/oval-spinner-black.svg" class="status_timer_spinner" alt="preloader spinner">
                                </div>
                        ...
                        {{/ifequal}} {{#ifequal status "PREPARING"}}
                        <section class="bg-white wrapper text-center cms-order-status">
                            <div>
                                <div class="status-countdown" id="_clock" style="margin-top: 0 !important;">
                                    <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/spinners/oval-spinner-black.svg" class="status_timer_spinner" alt="preloader spinner">
                        ...
                        {{/ifequal}} {{#ifequal status "PREPARED"}}
                        <section class="bg-white wrapper text-center cms-order-status">
                            <div>
                                <div class="status-countdown" id="_clock" style="margin-top: 0 !important;">
                                    <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/spinners/oval-spinner-black.svg" class="status_timer_spinner" alt="preloader spinner">
                        ...
                        {{/ifequal}} {{#ifequal status "READY_TO_PICKUP" "READY_TO_CONSUMER_PICKUP"}}
                        <section class="bg-white wrapper text-center cms-order-status">
                            <div>
                                <div class="status-countdown" id="_clock" style="margin-top: 0 !important;">
                                    <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/spinners/oval-spinner-black.svg" class="status_timer_spinner" alt="preloader spinner">
                        ...
                        {{/ifequal}} {{#ifequal status "IN_DELIVERY"}}
                        <section class="bg-white wrapper text-center cms-order-status">
                            <div>
                                <div class="status-countdown" id="_clock" style="margin-top: 0 !important;">
                                    <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/spinners/oval-spinner-black.svg" class="status_timer_spinner" alt="preloader spinner">
                        ...
                        {{/ifequal}} {{#ifequal status "COMPLETED"}}
                        <section class="bg-white wrapper text-center cms-order-status rejected">
                            <div>
                                <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/success.svg" alt="">
                                <h3 class="cms-order-status-title">
                        ...
                        <section class="bg-white wrapper text-center cms-order-status rejected">
                            <div>
                                <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/success.svg" alt=""> {{#ifequal status "READY_TO_CONSUMER_PICKUP"}}
                                <h3 class="cms-order-status-title">{{statusDetails.translation}}</h3>
                                <span class="text-muted">{{{message "cms_order_status_ready_to_pickup_consumer"}}}</span> {{else}}
                                <h3 class="cms-order-status-title">{{message "cms_order_status_processing_title"}}</h3>
                                <span class="text-muted">{{{message "cms_order_status_accepted_desc"}}}</span> {{/ifequal}}
                            </div>
                        </section>
                        {{/if}} {{/if}} {{/ifequal}} {{/ifequal}} {{#ifequal type "RESERVATION"}} {{else}} {{#ifequal status "ACCEPTED"}}
                        <!-- RATING -->
                        ...
                        {{/ifequal}} {{/ifequal}} {{#ifequal status "ACCEPTED"}} {{#ifequal type "RESERVATION"}} {{else}}
                        ...
                        <section class="bg-white cms-order-summary">
                                    ...
                                    <div class="col-sm-7">
                                        <table class="table table-no-border m-b-none">
                                            <tbody>
                                                    ...
                                                    <td class="p-l-none">
                                                        <ul class="list-unstyled m-b-xs">
                                                            <li class="break-word _order-form-product-name">
                                                                {{name}}{{#if variantName}}, {{variantName}} {{/if}} {{#if groupName}} / {{groupName}}{{/if}} {{#if comment}}
                                                                <div class="comment">
                                                                    <p>{{comment}}</p>
                                                                </div>
                                                                {{/if}} {{#addons}} {{#if quantity}} {{#if defaultQuantity}} {{else}}
                                                                <div class="hint _order-form-addon">+ {{#ifequal quantity "1"}}{{else}}{{toQty quantity}} x {{/ifequal}}{{name}}{{#if variantName}}, {{variantName}}{{/if}} {{#if groupName}} / {{groupName}}{{/if}} ({{toCurrency price @root.currency
                                                                    @root.language}} {{#if oldPrice}} <span class="cross" title="{{#discounts}} {{.}} {{/discounts}}">{{toCurrency oldPrice @root.currency @root.language}}</span>{{/if}}) </div>
                                                                {{/if}} {{else}}
                                                                <div class="hint cross _order-form-addon-old">+ {{#ifequal quantity "1"}}{{else}}{{defaultQuantity}} x {{/ifequal}}{{name}}{{#if variantName}}, {{variantName}}{{/if}} {{#if groupName}} / {{groupName}}{{/if}} ({{toCurrency price @root.currency
                                                                    @root.language}} {{#if oldPrice}}<span class="cross" title="{{#discounts}} {{.}} {{/discounts}}">{{toCurrency oldPrice @root.urrency @root.language}}</span>{{/if}}) </div>
                                                                {{/if}} {{/addons}} {{#if relatedNumber}}
                                                                <div class="theme-half-label m-t-xs">
                                                                ...
                                                                {{/if}} {{#if discounts}}
                                                                <div class="m-t-xs"><span class="label label-default text-ellipsis inline max-width-label help" title="{{#discounts}} {{.}} {{/discounts}}" data-toggle="tooltip">{{#discounts}} {{.}} {{/discounts}}</span></div>{{/if}}
                                                            </li>
                                                        </ul>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="p-l-none" colspan="2">
                                                        {{message "cms_order_deliveryCost"}} {{#if oldDeliveryCost}}
                                                        <div class="m-t-xs"><span class="label label-default text-ellipsis inline max-width-label help _order-form-delivery-promotion" title="{{deliveryDiscountPromotionName}}" data-toggle="tooltip">{{deliveryDiscountPromotionName}}</span></div>{{/if}}
                                                    </td>
                                                    <td class="text-right p-r-none">
                                                ...
                                                {{/if}} {{#if processingFees}} {{#processingFees}}
                                                <tr>
                                                    <td class="p-l-none" colspan="2">
                                                        {{name}}
                                                    </td>
                                                ...
                                                {{/processingFees}} {{/if}} {{#if tax.taxes}} {{#each tax.taxes}}
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="p-l-none" colspan="2">
                                                        {{#if discounts}}
                                                        <div class="m-t-xs"> {{#discounts}} <span class="label label-default text-ellipsis inline max-width-label help _order-form-discounts" title="{{.}}" data-toggle="tooltip">{{.}}</span> {{/discounts}}</div>{{/if}}
                                                    </td>
                                                    <td class="text-right p-r-none">
                                                        <span class="h4 _order-form-total-value">{{toCurrency totalCost @root.currency @root.language}}</span> {{#if oldTotalCost}}
                                                        <div class="cross _order-form-subtotal-old" title="{{#discounts}} {{.}} {{/discounts}}">{{toCurrency oldTotalCost @root.currency @root.language}}</div>{{/if}}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="_order-form-delivery-type">
                                                        {{#ifnull deliveryTypeName}} {{#ifnull deliveryType}}{{message "cms_order_deliveryType_delivery"}}{{/ifnull}} {{#ifequal deliveryType "DELIVERY"}}{{message "cms_order_deliveryType_delivery"}}{{/ifequal}} {{#ifequal deliveryType "TAKEAWAY"}}{{message "cms_order_deliveryType_takeaway"}}{{/ifequal}}
                                                        {{#ifequal deliveryType "ONSITE"}}{{message "cms_order_deliveryType_onsite"}}{{/ifequal}} {{#ifequal deliveryType "TABLE_ORDER"}}{{message "cms_order_deliveryType_table_order"}}{{/ifequal}} {{else}}
                                                        {{deliveryTypeName}} {{/ifnull}} {{#if deliveryDate}}
                                                        <br/><span class="_order-form-delivery-date" style="color: red">{{message "cms_order_deliveryType_deliveryDate"}}: <br/>{{deliveryDate}}</span> {{else}} {{message "cms_order_deliveryType_asap"}}
                                                        {{/if}}
                                                    </td>
                                                </tr>
                                                {{#ifequal deliveryType "TAKEAWAY"}} {{#if restaurant.city}}
                                                <tr>
                                                    <td>
                                                ...
                                                {{/if}} {{/ifequal}} {{#ifequal deliveryType "ONSITE"}} {{#if restaurant.city}}
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="_order-form-payment-type">
                                                        {{#ifequal paymentType "CASH"}} {{message "cms_order_paymentType_cash"}}{{/ifequal}} {{#ifequal paymentType "ONLINE"}} {{message "cms_order_paymentType_online"}} {{#if onlinePayment.paidDate}}
                                                        <br />{{message "cms_order_paymentType_onlinePaid"}} {{/if}} {{/ifequal}} {{#ifequal paymentType "CART"}}{{message "cms_order_paymentType_card"}}{{/ifequal}}
                                                    </td>
                                                </tr>
                                                {{/ifequal}} {{#ifequal type "RESERVATION"}}
                                                <tr>
                                                    <td>
                                                ...
                                                {{/if}} {{#if paymentType}} {{#if onlinePayment.paidDate}}
                                                <tr>
                                                    <td>
                                                        <strong>{{message "cms_order_reservation_paymentType"}}</strong>
                                                    </td>
                                                    <td>
                                                        {{#ifequal paymentType "ONLINE"}} {{message "cms_order_reservation_paymentType_online"}} {{/ifequal}}
                                                    </td>
                                                </tr>
                                                {{/if}} {{/if}} {{/ifequal}} {{#if people}}
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="break-word _order-form-invoice-data">
                                                        {{invoiceCompanyName}}<br/> {{{escapeXmlWithExclude invoiceAddress "br"}}}<br/> {{message "cms_order_taxId"}}: {{invoiceTaxId}}<br/>
                                                    </td>
                                                </tr>
                                                {{/if}} {{#ifequal deliveryType "DELIVERY"}}
                                                <tr>
                                                    <td>
                                                        <strong>{{message "cms_order_deliveryAddress"}}</strong>
                                                    </td>
                                                    <td class="break-word _order-form-customer-address">
                                                        {{{escapeXmlWithExclude formattedAddress}}} {{#if companyName}}
                                                        <br>{{message "cms_order_company"}}: {{companyName}} {{/if}}
                                                    </td>
                                                </tr>
                                                {{/ifequal}} {{#ifequal deliveryType "TABLE_ORDER"}}
                                                <tr>
                                                    <td>
                                                        <strong>
                                                ...
                                                {{else}} {{#unless personalDataDisabled}}
                                                <tr>
                                                    <td>
                                                        <strong>
                                                        {{#ifequal type "RESERVATION"}}
                            ...
                            <div class="alert alert-info alert-box m-b-none">
                                <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/icons/icon_question.png" alt=""> {{message "cms_order_contactRestaurant"}}
                                <a href="tel:{{restaurant.phone}}" class="no-wrap">{{restaurant.phone}}</a>{{#if restaurant.phone2}}, <a href="tel:{{restaurant.phone2}}" class="no-wrap">{{restaurant.phone2}}</a>{{/if}} {{#if restaurant.mobilePhone}}{{#if
                                restaurant.phone}}, {{/if}}<a href="tel:{{restaurant.mobilePhone}}" class="no-wrap">{{restaurant.mobilePhone}}</a>{{/if}}
                                <span class="order-id">
                        ...
                        <div class="row">
                            ...
                            {{/ifequal}}
                                ...
                                <div class="form-group inline {{#errors}} {{#ifequal field " delivery "}}has-error{{/ifequal}}{{/errors}}">
                                    ...
                                    {{#errors}} {{#ifequal field "delivery"}}
                                    <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group m-t-xs {{#errors}} {{#ifequal field " description "}}has-error{{/ifequal}}{{/errors}}">
                                    <textarea id="description" name="description" rows="3" class="form-control" placeholder="{{message " cms_order_rating_placeholder "}}">{{description}}</textarea> {{#errors}} {{#ifequal field "description"}}
                                    <div class="help-block">{{{error}}}</div>{{/ifequal}} {{/errors}}
                                </div>
                            </div>
                            <div class="col-sm-12">
...
<div class="modal-body">
            <form name='f' action='https://avocado-en.orderwebsite.com/login' method='POST' id="_login-form">
                ...
                <div class="form-group">
                    ...
                    <iframe src="index.html#" class="_fb-login-iframe" style="width: 100%; height: 40px; border: none; border-radius: 4px; margin-bottom: 5px;"></iframe>
                    <div class="login-btn" id="appleid-signin" data-color="black" data-border="true" data-type="sign in">
                    </div>
                ...
                <div class="control-group text-center">
                    <br/>
                    <a href="index.html#" id="_start-login-forgot-password">{{message "cms_login_lostPasswordBtn"}}</a><br/>
                    <a href="https://avocado-en.orderwebsite.com/?registration" id="_start-registration">{{message "cms_login_registrationBtn"}}</a>
                </div>
            </form>
        </div>
        <script>
...
<div class="modal-body registration-form-modal" style="overflow: visible;">
            ...
            {{else}}
            <form name='f' action='index.html#' method='POST' id="_registration-form">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group {{#errors}} {{#ifequal field " email "}}has-error{{/ifequal}}{{/errors}}">
                            <label class="control-label">{{{message "cms_registration_form_email"}}} *</label>
                            <input type='text' name="email" value="{{email}}" class="form-control" /> {{#errors}} {{#ifequal field "email"}}
                            <div class="help-block">{{error}}</div>{{/ifequal}} {{/errors}}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group {{#errors}} {{#ifequal field " password "}}has-error{{/ifequal}}{{/errors}}">
                            ...
                            <input type='password' id="customer-password" name='password' value="{{password}}" class="form-control" autocomplete="new-password" data-html="true" data-container="form" data-toggle="popover" data-trigger="focus" data-animation="true" data-placement="top"
                               ...
                               </div>" /> {{#errors}} {{#ifequal field "password"}}
                            <div class="help-block">{{error}}</div>{{/ifequal}} {{/errors}}
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group {{#errors}} {{#ifequal field " passwordConfirm "}}has-error{{/ifequal}}{{/errors}}">
                            ...
                            <input type='password' name='passwordConfirm' value="{{passwordConfirm}}" class="form-control" /> {{#errors}} {{#ifequal field "passwordConfirm"}}
                            <div class="help-block">{{error}}</div>{{/ifequal}} {{/errors}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="control-group">
                            <iframe src="index.html#" class="_fb-login-iframe" style="width: 100%; height: 40px; border: none; border-radius: 4px; margin-bottom: 5px;"></iframe>
                            <div lang="pl" class="apple-login-btn" id="appleid-signin" data-color="black" data-border="true" data-type="sign in">
                            </div>
                            <iframe id="googleIframe"></iframe>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <p class="text-center">
                            <br/>{{{message "cms_registration_form_haveAcccount"}}} <a href="index.html#" onclick=" jQuery('#_start-login').click(); return false;">{{{message "cms_registration_form_loginBtn"}}}</a>
                        </p>
                    </div>
                </div>
            </form>
...
<div class="modal-body">
            ...
            {{else}}
            <form name='f' action='index.html#' method='POST' id="_login-forgot-password-form">
                <div class="form-group {{#errors}} {{#ifequal field " email "}}has-error{{/ifequal}}{{/errors}}" ">
		...
		<div class="control-group text-center ">
					<br/>
				 	<a href="https://avocado-en.orderwebsite.com/?login " id="_start-login ">{{message "cms_forgot_password_loginBtn "}} </a><br />
					<a href="https://avocado-en.orderwebsite.com/?registration " id="_start-registration ">{{message "cms_forgot_password_registrationBtn "}}</a>
		</div>
		{{/if}}
</div>
...
<div class=" ">
    <div class="row ">
        ...
        <div class="row">
            <div class="col-sm-12">
                {{#range 1 points}} {{#if ../customImage}}
                <div class="loyalty-stamp-success" style="background-image: url('https://avocado-en.orderwebsite.com/{{../stampCollectedImage}}');"></div>
                {{else}}
                ...
                </span> {{/if}} {{/range}} {{#rangeUp points maxPointsForOrderCount}}
        ...
        {{/ifequal}} {{#ifequal type "POINTS_FOR_CASH"}} {{#ifequal points 0}} {{else}}
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="inline m-t-sm m-b-sm">
                    ...
                    <p class="m-t-xs m-b-none">
                        ...
                        <i class="feather-icon icon-help-circle v-middle m-t-n-3xxs text-primary" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="{{message " cms_order_loyalty_total_points_tooltip "}}"></i>
                    </p>
                </div>
            </div>
        </div>
        {{/ifequal}} {{/ifequal}} {{#if registerMessage}}
            ...
            <div class="row m-t">
                <div class="col-sm-6">
                    ...
                    <div class="m-b">
                        ...
                        {{#if restaurant.deliveryEnabled}} {{#deliveryAreas}} {{#areas}} {{#if ../active}}
                        <div><span class="delivery-color m-r-sm" style="background: {{backgroundColor}};"></span>{{toCurrency ../price ../../site.currency @root.language}}{{#if ../minOrderPrice}}, {{{message "cms_restaurant_info_delivery_min"}}}: {{toCurrency
                            ../minOrderPrice ../../site.currency @root.language}} {{/if}}{{#if ../freeDeliveryAbove}}, {{{message "cms_restaurant_info_free_delivery"}}}: {{toCurrency ../freeDeliveryAbove ../../site.currency @root.language}} {{/if}} </div>
                        {{/if}} {{/areas}} {{/deliveryAreas}} {{else}} {{{message "cms_restaurant_info_no_delivery"}}}<br/> {{/if}}
                    </div>
                    {{/ifequal}}
                    <div class="m-b">
                        ...
                        {{#if restaurant.street}} {{restaurant.street}}
                        <br/> {{/if}} {{#if restaurant.city}} {{restaurant.city}}{{#if restaurant.postalCode}}, {{restaurant.postalCode}} {{/if}}<br/> {{/if}}
                    </div>
                    <div class="m-b">
                        ...
                        {{#if restaurant.mobilePhone}} {{restaurant.mobilePhone}}
                        <br/> {{/if}} {{#if restaurant.phone}} {{restaurant.phone}}
                        <br/> {{/if}} {{#if restaurant.phone2}} {{restaurant.phone2}}
                        <br/> {{/if}}
                    </div>
                    <div class="m-b">
                        ...
                        {{#if restaurant.onlineOrderingEnabled}} {{{message "cms_restaurant_info_yes"}}} {{else}} {{{message "cms_restaurant_info_lack"}}} {{/if}}
                    </div>
                    {{#if cmsv4}} {{else}}
                    <div class="m-b">
                        ...
                        {{#if restaurant.onlineBookingEnabled}} {{{message "cms_restaurant_info_yes"}}} - <a href="index.html#" class="_show-booking-modal" data-restaurant-id="{{restaurant.id}}">{{{message "cms_restaurant_info_table_booking_btn"}}}</a>                        {{else}} {{{message "cms_restaurant_info_lack"}}} {{/if}}
                    </div>
                    {{/if}} {{#if restaurant.publishedRatings}}
                    <div class="m-b">
                        <h4 class="theme-restaurant-info-header "><i class="fa fa-fw fa-star-o" aria-hidden="true"></i>{{{message "cms_ratings_title"}}}</h4>
                        {{restaurant.averageGrade}} <i class="fa fa-fw fa-star yellow"></i> - <a href="index.html#" class="_show-ratings-modal" data-id="{{restaurant.id}}">{{message "cms_restaurant_info_show_ratings"}}</a>
                    </div>
                    {{/if}}
                    <div class="m-b">
                        ...
                        <div class="flex flex-align-center">
                            ...
                            <a href="https://avocado-en.orderwebsite.com/{{restaurant.facebook}}" target="_blank"><i class="fa-brands fa-facebook-f m-r text-muted" aria-hidden="true"></i></a> {{/if}} {{#if restaurant.twitter}}
                            <a href="https://avocado-en.orderwebsite.com/{{restaurant.twitter}}" target="_blank"><i class="fa-brands fa-x-twitter m-r text-muted" aria-hidden="true"></i></a> {{/if}} {{#if restaurant.instagram}}
                            <a href="https://avocado-en.orderwebsite.com/{{restaurant.instagram}}" target="_blank"><i class="fa-brands fa-instagram m-r text-muted" aria-hidden="true"></i></a> {{/if}} {{#if restaurant.tiktok}}
                            <a href="https://avocado-en.orderwebsite.com/{{restaurant.tiktok}}" target="_blank"><i class="fa-brands fa-tiktok m-r text-muted" aria-hidden="true"></i></a> {{/if}} {{#if restaurant.youtube}}
                            <a href="https://avocado-en.orderwebsite.com/{{restaurant.youtube}}" target="_blank"><i class="fa-brands fa-youtube m-r text-muted" aria-hidden="true"></i></a> {{/if}} {{#if restaurant.tripAdvisor}}
                            <a href="https://avocado-en.orderwebsite.com/{{restaurant.tripAdvisor}}" class="text-muted" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" class="text-muted m-t-xs" fill="currentColor" width="16px" height="16px" viewBox="0 0 24 24" role="img"><title>Tripadvisor icon</title><path d="M12.006 4.295c-2.67 0-5.338.784-7.645 2.353H0l1.963 2.135a5.997 5.997 0 0 0 4.04 10.43 5.976 5.976 0 0 0 4.075-1.6L12 19.705l1.922-2.09a5.972 5.972 0 0 0 4.072 1.598 6 6 0 0 0 6-5.998 5.982 5.982 0 0 0-1.957-4.432L24 6.648h-4.35a13.573 13.573 0 0 0-7.644-2.353zM12 6.255c1.531 0 3.063.303 4.504.903C13.943 8.138 12 10.43 12 13.1c0-2.671-1.942-4.962-4.504-5.942A11.72 11.72 0 0 1 12 6.256zM6.002 9.157a4.059 4.059 0 1 1 0 8.118 4.059 4.059 0 0 1 0-8.118zm11.992.002a4.057 4.057 0 1 1 .003 8.115 4.057 4.057 0 0 1-.003-8.115zm-11.992 1.93a2.128 2.128 0 0 0 0 4.256 2.128 2.128 0 0 0 0-4.256zm11.992 0a2.128 2.128 0 0 0 0 4.256 2.128 2.128 0 0 0 0-4.256z"/></svg></a>
                            {{/if}}
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="m-b">
                        ...
                        {{else}} {{#if restaurant.futureOrdering}}
                        ...
                        <table>
                            ...
                            <tr>
                                <td class="td-theme-day">
                                    {{#if from}} {{#ifequal from "MONDAY"}}{{{message "cms_monday"}}} {{/ifequal}} {{#ifequal from "TUESDAY"}}{{{message "cms_tuesday"}}} {{/ifequal}} {{#ifequal from "WEDNESDAY"}}{{{message "cms_wednesday"}}} {{/ifequal}} {{#ifequal from "THURSDAY"}}{{{message
                                    "cms_thursday"}}} {{/ifequal}} {{#ifequal from "FRIDAY"}}{{{message "cms_friday"}}} {{/ifequal}} {{#ifequal from "SATURDAY"}}{{{message "cms_saturday"}}} {{/ifequal}} {{#ifequal from "SUNDAY"}}{{{message "cms_sunday"}}}
                                    {{/ifequal}} {{/if}} {{#if to}} - {{#ifequal to "MONDAY"}}{{{message "cms_monday"}}} {{/ifequal}} {{#ifequal to "TUESDAY"}}{{{message "cms_tuesday"}}} {{/ifequal}} {{#ifequal to "WEDNESDAY"}}{{{message "cms_wednesday"}}}
                                    {{/ifequal}} {{#ifequal to "THURSDAY"}}{{{message "cms_thursday"}}} {{/ifequal}} {{#ifequal to "FRIDAY"}}{{{message "cms_friday"}}} {{/ifequal}} {{#ifequal to "SATURDAY"}}{{{message "cms_saturday"}}} {{/ifequal}} {{#ifequal
                                    to "SUNDAY"}}{{{message "cms_sunday"}}} {{/ifequal}} {{/if}}
                                </td>
                                <td>
                                    {{#periods}} {{from}} - {{to}}<br> {{/periods}}
                                    <td>
                            </tr>
                            {{/restaurant.openingHoursRange}}
                        </table>
                    ...
                    <div class="m-b">
                        ...
                        {{else}} {{{message "cms_restaurant_info_delivery_hours_same"}}} {{/if}} {{/if}}
                    </div>
                    <div class="m-b">
                        ...
                        {{else}} {{{message "cms_restaurant_info_takeaway_hours_same"}}} {{/if}} {{/if}}
                    </div>
                    <div class="m-b">
                        ...
                        {{#if restaurant.cashPayment}} {{{message "cms_restaurant_info_payment_cash"}}}<br/> {{/if}} {{#if restaurant.cardPayment}} {{{message "cms_restaurant_info_payment_card"}}}<br/> {{/if}} {{#if restaurant.onlinePayment}} {{{message
                        "cms_restaurant_info_payment_online"}}}
                        <br/> {{/if}}
                    </div>
                    <div class="m-b">
                        ...
                        {{#if restaurant.delivery}} {{{message "cms_restaurant_info_delivery_delivery"}}} <br/> {{/if}} {{#if restaurant.takeaway}} {{{message "cms_restaurant_info_delivery_takeaway"}}} {{#ifnull restaurant.takeAwayMinPrice}} {{else}}
                        (min: {{toCurrency restaurant.takeAwayMinPrice site.currency @root.language}}) {{/ifnull}}
                        <br/> {{/if}} {{#if restaurant.onsite}} {{{message "cms_restaurant_info_delivery_onsite"}}} {{#if restaurant.onSiteMinPrice}} (min: {{toCurrency restaurant.onSiteMinPrice site.currency @root.language}}) {{/if}}
                        <br/> {{/if}}
                    </div>
                    ...
                    <div class="m-b">
                        ...
                        <a href="https://play.google.com/store/apps/details?id={{site.googlePlayAppId}}" target="_blank">
                            <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/google-play-download.png" style="width: 160px;" />
                        </a>
                        {{/if}} {{#if site.appleItunesAppId}}
                        <a href="http://itunes.apple.com/app/id{{site.appleItunesAppId}}" target="_blank">
                            <img src="https://avocado-en.orderwebsite.com/{{static_url}}/images/appstore-download.png" style="width: 160px;" />
                        </a>
                        {{/if}}
                    </div>
                    {{/hasPermission}}
...
{{#if ratingsPublished}} {{#ratingsPublished}}
        <div class="col-sm-12 theme-rating">
            <div class="theme-star-rating">
                ...
                <div class="theme-rating-block">
                    <p class="small inline m-r-xs">
                        {{#ifequal deliveryType "DELIVERY"}} {{message "cms_order_rating_delivery"}} {{else}} {{message "cms_order_rating_service"}} {{/ifequal}}
                    </p>
...
{{#ifequal restaurants.length 1}} {{#restaurants}} {{#if onlineBookingDisabledDescription}}
        ...
        {{/if}} {{/restaurants}} {{/ifequal}} {{#if showForm}} {{#if restaurants}}
        <div>
                ...
                <div class="row">
                        ...
                        <div class="form-group  {{#reservation.errors}} {{#ifequal field " restaurantId "}} has-error {{/ifequal}} {{/reservation.errors}}">
                            ...
                            <select id="restaurantId" class="form-control">
                                    ...
                                    {{#restaurants}}
                                        ...
                                        {{/if}}
                                    {{/restaurants}}
                                </select> {{#reservation.errors}} {{#ifequal field "restaurantId"}}
                            <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group {{#reservation.errors}} {{#ifequal field " toDate "}} has-error {{/ifequal}} {{/reservation.errors}}">
                            ...
                            <input type="text" placeholder="{{{message " cms_order_deliveryDate_future_date "}}}" id="_reservation-delivery-date" class="form-control _reservation-delivery-date" autocomplete="off" readonly/> {{#reservation.errors}} {{#ifequal
                            field "toDate"}}
                            <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group {{#reservation.errors}} {{#ifequal field " toTime "}} has-error {{/ifequal}} {{/reservation.errors}}">
                            ...
                            </select> {{#reservation.errors}} {{#ifequal field "toTime"}}
                            <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group {{#reservation.errors}} {{#ifequal field " people "}} has-error {{/ifequal}} {{/reservation.errors}}">
                            ...
                            <select id="people" class="form-control">
                                ...
                                {{/reservation.settings.peopleList}}
                            </select> {{#reservation.errors}} {{#ifequal field "people"}}
                            <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                        </div>
                    </div>
                    <div class="col-sm-6 _reservation-form-details" style="display: none;">
                        <div class="form-group {{#reservation.errors}} {{#ifequal field " firstName "}} has-error {{/ifequal}} {{/reservation.errors}}">
                            ...
                            <input type="text" id="firstName" value="{{reservation.firstName}}" class="form-control" name="firstName" /> {{#reservation.errors}} {{#ifequal field "firstName"}}
                            <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                        </div>
                    </div>
                    <div class="col-sm-6 _reservation-form-details" style="display: none;">
                        <div class="form-group {{#reservation.errors}} {{#ifequal field " lastName "}} has-error {{/ifequal}} {{/reservation.errors}}">
                            ...
                            <input type="text" id="lastName" value="{{reservation.lastName}}" class="form-control" name="lastName" /> {{#reservation.errors}} {{#ifequal field "lastName"}}
                            <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                        </div>
                    </div>
                    <div class="col-sm-6 _reservation-form-details" style="display: none;">
                        <div class="form-group {{#reservation.errors}} {{#ifequal field " email "}} has-error {{/ifequal}} {{/reservation.errors}}">
                            ...
                            <input type="text" id="email" value="{{reservation.email}}" class="form-control" name="email" /> {{#reservation.errors}} {{#ifequal field "email"}}
                            <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                        </div>
                    </div>
                    <div class="col-sm-6 _reservation-form-details" style="display: none;">
                        <div class="form-group {{#reservation.errors}} {{#ifequal field " phone "}} has-error {{/ifequal}} {{/reservation.errors}}">
                            ...
                            <input type="tel" id="phone" name="phone" value="{{reservation.phone}}" data-phone="{{reservation.phone}}" class="form-control decimal-only" data-additional-allowed-characters="- " /> {{#reservation.errors}} {{#ifequal field
                            "phone"}}
                            <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                        </div>
                    </div>
                    <div class="col-sm-12 _reservation-form-details" style="display: none;">
                        <div class="form-group {{#reservation.errors}} {{#ifequal field " comment "}} has-error {{/ifequal}} {{/reservation.errors}}">
                            ...
                            <textarea id="comment" class="form-control" rows="2">{{reservation.comment}}</textarea> {{#reservation.errors}} {{#ifequal field "comment"}}
                            <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                        </div>
                    </div>
                        ...
                        <div class="checkbox">
                            <label>
                                    ...
                                    {{#if reservation.settings.termsOfServiceUrl}}
                                        <a href="https://avocado-en.orderwebsite.com/{{{reservation.settings.termsOfServiceUrl}}}" target="_blank">{{message "cms_order_termsOfServiceUrl"}}</a>
                                    {{else}}
                                        {{#if reservation.settings.termsOfServiceContent}}
                                            <a href="index.html#" id="_show-terms-of-service-reservation">{{message "cms_order_termsOfServiceUrl"}}</a>
                                        {{/if}}
                                    {{/if}}
                                    ...
                                    {{#if reservation.settings.privacyPolicyUrl}}
                                        <a href="https://avocado-en.orderwebsite.com/{{{reservation.settings.privacyPolicyUrl}}}" target="_blank">{{message "cms_order_privacyPolicyUrl"}}</a>
                                    {{else}}
                    ...
                    <div class="col-sm-12 _reservation-form-details" style="display: none;">
                        <div class="">
                            <label>
                                        ...
                                        {{#if reservation.settings.privacyPolicyUrl}}
                                            {{message "cms_order_privacyPolicy"}}
                                            <a href="https://avocado-en.orderwebsite.com/{{{reservation.settings.privacyPolicyUrl}}}"
                    ...
                    <div class="col-sm-12">
                        <a href="index.html" class="btn btn-upmenu btn-block btn-lg _booking-form-submit">{{{message "cms_reservation_reservation_btn"}}}</a>
                    </div>
                </div>
            </form>
        </div>
...
<div class="cart-wrapper theme-cart-mini-context theme-context-wrapper m-b {{#if cmsv4}}cmsv4{{/if}}">
            <div class="clearfix m-b-sm">
                ...
                {{/ifequal}} {{#if restaurant.onlineOrderingEnabled}} {{#if tableNumber}} {{else}} {{#if customer.registered}}
                <div class="dropdown user-account text-right pull-right">
                    <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown"><span class="text-ellipsis inline">{{#if customer.firstName}}{{customer.firstName}}{{else}}{{customer.email}}{{/if}}</span><i
                ...
                {{else}}
                <div class="dropdown user-account text-right pull-right">
                    <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown"><span class="text-ellipsis inline">{{message "cms_cart_account_btn"}}</span><i class="fa fa-fw fa-angle-down"></i></a>
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="https://avocado-en.orderwebsite.com/?login" id="_start-login">{{message "cms_cart_login"}}</a></li>
                        <li><a href="https://avocado-en.orderwebsite.com/?registration" id="_start-registration">{{message "cms_cart_create_account"}}</a></li>
                    </ul>
            ...
            <div>
                <a href="index.html#" class="inline _show-ratings-modal" data-id="{{restaurant.id}}">
            ...
            <div>
                ...
                <div>
                    <div class="_toggle-cart-hours pointer clearfix">
                        {{#if restaurant.openNow}}
                        <span class="green small"><strong>{{{message "cms_hours_open"}}}</strong><i class="fa fa-circle v-middle m-l-xs m-r-xs m-t-n-2xxs"></i>{{restaurant.openUntil}}&nbsp;<i class="fa fa-fw fa-angle-down"></i></span> {{else}} {{#if restaurant.futureOrdering}}
                        <span class="yellow small"><strong>{{{message "cms_hours_closed"}}}</strong><i class="fa fa-circle v-middle m-l-xs m-r-xs m-t-n-2xxs"></i>{{message "cms_restaurant_info_future_order"}}&nbsp;<i class="fa fa-fw fa-angle-down"></i></span>                        {{else}}
                        <span class="red small"><strong>{{{message "cms_hours_closed"}}}</strong><i class="fa fa-circle v-middle m-l-xs m-r-xs m-t-n-2xxs"></i>{{restaurant.openFrom}}&nbsp;<i class="fa fa-fw fa-angle-down"></i></span> {{/if}} {{/if}}
                    </div>
...
{{#if customer.registered}}
        ...
        {{else}}
        <a href="index.html#" class="dropdown-toggle account" data-toggle="dropdown">
            <i class="fa fa-user-o"></i> {{message "cms_cart_account_btn"}}
        </a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="https://avocado-en.orderwebsite.com/?login" id="_start-login">{{message "cms_cart_login"}}</a></li>
            <li><a href="https://avocado-en.orderwebsite.com/?registration" id="_start-registration">{{message "cms_cart_create_account"}}</a></li>
...
<div class="modal-header _my-account-modal">
            <ul class="nav nav-tabs">
                ...
                <li class="active">
                    <a href="index.html#" id="_start-edit-customer">{{message "cms_customer_account_form_title"}}</a>
                </li>
                <li><a href="index.html#" id="_show-customer-orders">{{message "cms_customer_account_orders_title"}}</a></li>
            </ul>
        </div>
        <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group {{#command.errors}}{{#ifequal field " firstName "}}has-error{{/ifequal}}{{/command.errors}}">
                                    ...
                                    <input type='text' name='firstName' value="{{command.firstName}}" class="form-control" /> {{#command.errors}} {{#ifequal field "firstName"}}<span class="help-block">{{{error}}}</span>{{/ifequal}} {{/command.errors}}
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group {{#command.errors}}{{#ifequal field " lastName "}}has-error{{/ifequal}}{{/command.errors}}">
                                    ...
                                    <input type='text' name='lastName' value="{{command.lastName}}" class="form-control" /> {{#command.errors}} {{#ifequal field "lastName"}}<span class="help-block">{{{error}}}</span>{{/ifequal}} {{/command.errors}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group {{#command.errors}}{{#ifequal field " city "}}has-error{{/ifequal}}{{/command.errors}}">
                                    ...
                                    <input type='text' name='city' value="{{command.city}}" id="city" class="form-control" /> {{#command.errors}} {{#ifequal field "city"}}<span class="help-block">{{{error}}}</span>{{/ifequal}} {{/command.errors}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group {{#command.errors}}{{#ifequal field " street "}}has-error{{/ifequal}}{{/command.errors}}">
                                    ...
                                    <div id="_delivery-info">
                                        {{#command.errors}} {{#ifequal field "street"}}<span class="help-block">{{{error}}}</span>{{/ifequal}} {{/command.errors}}
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group {{#command.errors}}{{#ifequal field " streetNumber "}}has-error{{/ifequal}}{{/command.errors}}">
                                    ...
                                    <input type="text" name="streetNumber" value="{{command.streetNumber}}" id="streetNumber" class="form-control" /> {{#command.errors}} {{#ifequal field "streetNumber"}}<span class="help-block">{{{error}}}</span>{{/ifequal}}
                                    {{/command.errors}}
                                </div>
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group {{#command.errors}}{{#ifequal field " phone "}}has-error{{/ifequal}}{{/command.errors}}">
                                    ...
                                    <input type="tel" name="phone" value="{{command.phone}}" data-phone="{{command.phone}}" class="form-control decimal-only" data-additional-allowed-characters="- " /> {{#command.errors}} {{#ifequal field "phone"}}
                                    <span class="help-block">{{{error}}}</span>{{/ifequal}} {{/command.errors}}
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group {{#command.errors}}{{#ifequal field " companyName "}}has-error{{/ifequal}}{{/command.errors}}">
                                    ...
                                    <input type="text" name="companyName" value="{{command.companyName}}" class="form-control" /> {{#command.errors}} {{#ifequal field "companyName"}}<span class="help-block">{{{error}}}</span>{{/ifequal}} {{/command.errors}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group {{#command.errors}}{{#ifequal field " password "}}has-error{{/ifequal}}{{/command.errors}}">
                                    ...
                                    <input type="password" name="password" value="{{command.password}}" class="form-control" id="customer-password-change" autocomplete="new-password" data-html="true" data-container="#customer-account-form" data-toggle="popover" data-trigger="focus" data-animation="true"
                                        data-placement="top" data-template="<div class='popover' role='tooltip' style='margin-left: 40px !important'><div class='arrow'></div><div class='popover-content wrapper'></div></div>" data-content="<div class='inner password-popover'>
                                    <div class='password-strength' data-strength='0'>
                                        <p>
                                            <span>{{message " registration_password_no_password "}}</span>
                                            <span>{{message "registration_password_strength_weak "}}</span>
                                    ...
                                    <a href="index.html#" class="show-password">
                                        <span class="eye-hide">
                                    <svg
                                    ...
                                    {{#command.errors}} {{#ifequal field "password"}}<span class="help-block">{{{error}}}</span>{{/ifequal}} {{/command.errors}}
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group {{#command.errors}}{{#ifequal field " passwordConfirm "}}has-error{{/ifequal}}{{/command.errors}}">
                                    ...
                                    {{#command.errors}} {{#ifequal field "passwordConfirm"}}<span class="help-block">{{{error}}}</span>{{/ifequal}} {{/command.errors}}
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal-header">
            ...
            <div class="modal-close">
                ...
                src="https://avocado-en.orderwebsite.com/{{{static_url}}}/images/icons/x.svg"></button>
            </div>
        </div>
        {{#if promotions}} {{#promotions}} {{#ifequal ../promotionId id}}
        <div class="modal-content">
            <div class="modal-body">
                <img class="promotions-image-single img-responsive" src="https://avocado-en.orderwebsite.com/{{image.huge_url}}" />
...
<div>
        ...
        {{/if}}">
                <div class="modal-sections">
                    ...
                    {{#if image}}
                    <div class="row">
                        <img src="https://avocado-en.orderwebsite.com/{{image.huge_url}}" class="img-responsive center-block theme-buying-flow-image">
                    </div>
                    {{/if}}
                    <div class="row theme-buying-flow-row">
                        <div class="col-sm-12 m-b-sm text-left">
                            ...
                            {{/if}} {{#if productDescription}} {{{menuDescriptionHelper productDescription}}} {{/if}}
                            <div class="theme-price m-b-none">
                                {{toCurrency productPrice site.currency locale}}
                            </div>
                        </div>
                    </div>
                    {{#unless disabled}} {{#if types}}
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row theme-modal-section-row _buying-flow-step-group" data-addon-id="{{productAddonId}}">
                                <div>
                                    <h4 class="theme-modal-section-title">
                                        <div>
                                            {{{escapeJs name}}} {{#if description}}
                                            <small class="description">{{{description}}}</small> {{/if}}
                                            <small class="limits">
                                ...
                                <div class="col-xs-12">
                                    <div class="theme-buying-flow-row">
                                        {{#if errors}}
                                        <div class="alert-danger"></div>{{/if}} {{#products}}
                                        <div class="m-b-md single-add-on">
                                            <label class="additives-flex pointer" data-html="true" data-container="body" data-toggle="popover" data-trigger="click hover" data-animation="true" data-template="<div class='popover' role='tooltip'><div class='arrow'></div><h3 class='popover-title'></h3><div class='popover-content _product-popover-content'></div></div>"
                                                data-content="
                                                                    <div class='row _product-popover'>
                                                                        {{#if imageDto.compact_url}}
                                                                            <div class='row-eq-height'>
                                                                                <div class='col-lg-6'>
                                                                                    <img class='img-responsive' src='https://avocado-en.orderwebsite.com/{{imageDto.compact_url}}'/>
                                                                                </div>
                                            ...
                                            <div class="btn-group btn-tipping-width m-r-sm">
                                                <button type="button" class="btn _buying-flow-add-single-product
                                                                                        {{#if quantity}} is-added _buying-flow-remove-product {{else}} _buying-flow-add-product {{/if}}" {{#if canAdd}}{{else}} {{#if quantity}} {{else}} disabled {{/if}}
                                                    {{/if}} data-id="{{id}}">
                                                                                    <i class="fa {{#if quantity}}fa-check{{/if}}" aria-hidden="true"></i>
                                                                                </button>
                                            </div>
                                            {{/if}} {{else}}
                                            <div class="btn-group btn-tipping-width m-r-sm">
                                                <button type="button" class="btn _buying-flow-product-quantity-btn
                                                                                {{#if quantity}} is-added {{/if}}
                                                                                        {{#if canAdd}} _buying-flow-add-product {{/if}}" {{#if canAdd}} {{else}} disabled {{/if}} data-id="{{id}}">
                                        ...
                                        <div class="additives-flex-left" title="{{#if description}}{{escapeXml description}}{{/if}}" data-toggle="tooltip">
                                            <div class="text-ellipsis text-left" {{#if canAdd}} {{else}} disabled {{/if}} data-id="{{id}}">
                                                {{escapeJs name}} {{#if type1}}
                                                <span class="theme-buying-flow-type">, {{escapeJs type1}}</span> {{/if}}
                                            </div>
                                        </div>
                                        <div class="additives-flex-right">
                                            {{#ifequal price 0}}{{else}}
                                            ...
                                            {{/ifequal}} {{#if ../singleChoice}} {{else}} {{#ifequal ../maxQuantity 1}} {{else}} {{#ifequal quantity 0}}{{else}}
                                            <button type="button" class="btn btn-remove m-l-xs
                                                                                {{#if canRemove}}_buying-flow-remove-product{{/if}}" {{#if canRemove}} {{else}} disabled {{/if}} data-id="{{id}}">
        ...
        <div class="modal-footer {{#if disabled}}footer-short{{/if}}">
            ...
            <div class="_scroll-modal" style="display: none;">
                <a href="index.html#" class="btn"><i class="fa fa-arrow-down"></i>&nbsp;{{message "cms_buying_flow_scroll_btn"}}</a>
            </div>
            {{/unless}} {{#if errors}}
            ...
            <div class="_buying-flow-buttons media-flex">
                ...
                <button type="button" class="btn btn-default btn-lg _buying-flow-previous-step">
                        ...
                        </button> {{/unless}} {{#unless lastStep}}
                <button type="button" class="btn btn-upmenu btn-lg _buying-flow-next-step flex-grow">{{message "cms_buying_flow_next"}}</button> {{/unless}} {{#if lastStep}}
...
<li class="theme-nav-customer-account">
            ...
            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dLabel">
                <li><a href="index.html#" id="_start-edit-customer">{{message "cms_cart_account" lang=cmsEditLang}}</a></li>
                <li><a href="index.html#" id="_start-logout">{{message "cms_cart_logout" lang=cmsEditLang}}</a></li>
            </ul>
            {{else}}
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                <li><a href="https://avocado-en.orderwebsite.com/?login" id="_start-login">{{message "cms_cart_login" lang=cmsEditLang}}</a></li>
                <li><a href="https://avocado-en.orderwebsite.com/?registration" id="_start-registration">{{message "cms_cart_create_account" lang=cmsEditLang}}</a></li>
            </ul>
            {{/if}}
        </li>
...
<div id="_delivery-check-form-wrapper">
            ...
            <form id="delivery-check-form">
                ...
                <div class="row check-form-narrow">
                    <input type="hidden" class="form-control" name="latitude" id="latitude" value="" />
                    <input type="hidden" class="form-control" name="longitude" id="longitude" value="" /> {{#if restaurantSearchForm}}
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="row">
                                {{#if restaurantSearchForm.settings.deliveryEnabled}}
                ...
                {{else}} {{#if restaurant}}{{else}} {{#ifequal site.themeStoreType "PORTAL"}}
                                                            ...
                                                            <div class="col-lg-{{largeWidth}} col-md-{{mediumWidth}} col-xs-{{smallWidth}}">
                                                                <div class="form-group {{#each ../errors}} {{#ifequal field ../name}}has-error{{/ifequal}} {{/each}}">
                                                                    ...
                                                                    <input type="text" name="{{name}}" data-required="{{required}}" value="{{#ifequal name " street "}}{{../street}}{{/ifequal}}{{#ifequal name "streetNumber "}}{{../streetNumber}}{{/ifequal}}{{#ifequal name "city
                                                                        "}}{{../city}}{{/ifequal}}{{#ifequal name "postalCode "}}{{../postalCode}}{{/ifequal}}{{#ifequal name "region "}}{{../region}}{{/ifequal}}{{#ifequal name "apartmentNumber "}}{{../apartmentNumber}}{{/ifequal}}{{#ifequal name "floorNumber
                                                                        "}}{{../floorNumber}}{{/ifequal}}{{#ifequal name "customAddressField1Value "}}{{../customAddressField1Value}}{{/ifequal}}{{#ifequal name "customAddressField2Value "}}{{../customAddressField2Value}}{{/ifequal}}{{#ifequal name "customAddressField3Value
                                                                        "}}{{../customAddressField3Value}}{{/ifequal}}" id="{{name}}" class="form-control " placeholder="{{label}}{{#if required}} *{{/if}}" /> {{/ifequal}} {{#ifequal type
                                                                    "SELECT"}}
                                                                    <select name="{{name}}" data-required="{{required}}" class="form-control" id="{{name}}">
                                                                                            <option value="">{{label}}{{#if required}} *{{/if}}</option>
                                                                                            {{#values}}
                    ...
                    <div class="col-sm-12">
                            ...
                            <div class="{{#ifequal menuSettings.restaurantsLayout " list " "boxes " "portal-boxes "}}col-sm-12{{else}}col-sm-6{{/ifequal}}">
                                <div class="search-holder flex flex-align-center {{#ifequal menuSettings.restaurantsLayout " list "}}check-form-narrow{{/ifequal}}">
                                    ...
                                    <div class="types-bar-holder">
                                        ...
                                        <div class="types-bar">
                                            <a href="index.html#" class="btn-upmenu all selected">{{message "cms_restaurant_info_portal_all"}}</a> {{#kitchenTypes}}
                                            <a href="index.html#" class="btn-upmenu index-{{@index}} {{#compare @index 8 operator=">="}}more-item{{/compare}}">{{name}}</a> {{/kitchenTypes}} {{#compare kitchenTypes.length 8 operator=">"}}
                                            <a href="index.html#" class="btn-upmenu show-more-btn">{{message "cms_restaurant_info_portal_more"}} <i class="fa fa-fw fa-angle-down" aria-hidden="true"></i></a>
                                            <a href="index.html#" class="btn-upmenu show-less-btn more">{{message "cms_restaurant_info_portal_less"}} <i class="fa fa-fw fa-angle-up" aria-hidden="true"></i></a> {{/compare}}
                                        </div>
                                    </div>
                                    {{else}}
                                    <div class="search-bar m-b-md m-t-sm pull-right" style="display: none;">
                        ...
                        <div class="row check-form-restaurants" {{#ifequal menuSettings.hideRestaurants "true"}}{{#unless editModeCms4}}style="display: none;" {{/unless}}{{/ifequal}}>
                            ...
                            <div id="_delivery-check-restaurants" class="delivery-check-restaurants-box-images">
                                ...
                                {{#ifnull deliveryCost}} {{else}} _restaurant-delivery-ok {{/ifnull}} {{attributes.cssClass}}" id="_restaurant-{{id}}" data-id="{{id}}" data-takeaway="{{takeaway}}" data-delivery="{{delivery}}" data-onsite="{{onsite}}"
                                    data-lat="{{latitude}}" data-lng="{{longitude}}">
                                    <a href="https://avocado-en.orderwebsite.com/{{#if attributes.restaurantCustomUrl}}{{attributes.restaurantCustomUrl}}{{else}}{{url}}{{/if}}{{#if ../productId}}?pid={{../productId}}{{/if}}" class="restaurant-box-image" style="background-image: url({{#if attributes.restaurantImage_url}}{{attributes.restaurantImage_url}}{{else}}{{logoImageUrl}}{{/if}}); ">
                                        {{#if ../restaurantTemplate}}
                                            {{{eval . value=../restaurantTemplate}}}
                                        {{else}}
                            ...
                            {{else}} {{#ifequal menuSettings.restaurantsLayout "list"}}
                            <div class="col-sm-12">
                                <div id="_delivery-check-restaurants" class="delivery-check-restaurants-simple-list check-form-narrow">
                                    <div class="restaurants-scrollable">
                                        <div class="list-group">
                                ...
                                {{else}} {{#ifequal menuSettings.restaurantsLayout "portal-boxes"}}
                                <div id="_delivery-check-restaurants" class="delivery-check-restaurants-portal-boxes">
                                    {{#restaurants}}
                                    <div class="col-md-4 col-sm-6 col-xs-12 m-b-30 _restaurant flex
                                             {{#ifnull deliveryCost}} {{else}} _restaurant-delivery-ok {{/ifnull}} {{attributes.cssClass}}" id="_restaurant-{{id}}" data-id="{{id}}" data-takeaway="{{takeaway}}" data-delivery="{{delivery}}" data-onsite="{{onsite}}"
                                        data-lat="{{latitude}}" data-lng="{{longitude}}">
                                        <a href="https://avocado-en.orderwebsite.com/{{#if attributes.restaurantCustomUrl}}{{attributes.restaurantCustomUrl}}{{else}}{{url}}{{/if}}{{#if ../productId}}?pid={{../productId}}{{/if}}" class="restaurant-box-image">
                                                {{#if ../restaurantTemplate}}
                                                    {{{eval . value=../restaurantTemplate}}}
                                                {{else}}
                                                    <div class='rest-box-wrapper {{#ifequal openNow false}}closed{{/ifequal}}'
                                                    ...
                                                    >
                                                        {{#if logoImageUrl}}
                                                            <div class="portal-logo-box">
                                                                <img src="https://avocado-en.orderwebsite.com/{{#if logoImageUrl}}{{logoImageUrl}}{{/if}}" />
                                                            </div>
                                                        {{/if}}
                                                        <div class='image-wrapper'>
                                                            <div class="restaurant-logo-wrapper"
                                                                 style="background-image: url('https://avocado-en.orderwebsite.com/{{');">
                                                                {{#ifequal openNow false}}
...
<form action="https://avocado-en.orderwebsite.com/restapi/booking" class="_booking-form">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <input type="hidden" id="restaurantId" value="{{reservation.restaurantId}}" name="restaurantId" /> {{else}}
                    <div class="form-group {{#reservation.errors}} {{#ifequal field " restaurantId "}} has-error {{/ifequal}} {{/reservation.errors}}">
                        <select id="restaurantId" class="form-control">
            ...
            <fieldset disabled="disabled">
                {{else}} {{#ifequal reservation.restaurantId null "undefined"}}
                <fieldset disabled="disabled">
                    {{else}} {{#ifequal restaurants.length 1}} {{#restaurants}} {{#unless onlineBookingEnabled}}
                    <fieldset disabled="disabled">
                        {{/unless}} {{/restaurants}} {{else}} {{#restaurants}} {{#ifequal ../reservation.restaurantId id}} {{#unless onlineBookingEnabled}}
                        <fieldset disabled="disabled">
                            {{/unless}} {{/ifequal}} {{/restaurants}} {{/ifequal}} {{/ifequal}} {{/if}}
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group {{#reservation.errors}} {{#ifequal field " people "}} has-error {{/ifequal}} {{/reservation.errors}}">
                                        <select id="people" class="form-control">
                    ...
                    {{/reservation.settings.peopleList}}
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{#reservation.errors}} {{#ifequal field " toDate "}} has-error {{/ifequal}} {{/reservation.errors}}">
                                        <input type="hidden" id="reservation-date-hidden" value="{{reservation.toDate}}" name="toDate" />
                                        <input type="text" id="_reservation-delivery-date" class="form-control _reservation-delivery-date" placeholder="{{{message " cms_reservation_date "}}} *" autocomplete="off" readonly/> {{#reservation.errors}} {{#ifequal
                                        field "toDate"}}
                                        <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                                    </div>
                                </div>
                    ...
                    {{/if}}
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{#reservation.errors}} {{#ifequal field " firstName "}} has-error {{/ifequal}} {{/reservation.errors}}">
                                        <input type="text" id="firstName" value="{{reservation.firstName}}" class="form-control" name="firstName" placeholder="{{{message " cms_reservation_first_name "}}} *" /> {{#reservation.errors}} {{#ifequal field
                                        "firstName"}}
                                        <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group {{#reservation.errors}} {{#ifequal field " lastName "}} has-error {{/ifequal}} {{/reservation.errors}}">
                                        <input type="text" id="lastName" value="{{reservation.lastName}}" class="form-control" name="lastName" placeholder="{{{message " cms_reservation_last_name "}}} *" /> {{#reservation.errors}} {{#ifequal field "lastName"}}
                                        <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group {{#reservation.errors}} {{#ifequal field " email "}} has-error {{/ifequal}} {{/reservation.errors}}">
                                        <input type="text" id="email" value="{{reservation.email}}" class="form-control" name="email" placeholder="{{{message " cms_reservation_email "}}} *" /> {{#reservation.errors}} {{#ifequal field "email"}}
                                        <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group {{#reservation.errors}} {{#ifequal field " phone "}} has-error {{/ifequal}} {{/reservation.errors}}">
                                        <input type="hidden" id="phoneCountryCode" name="phoneCountryCode" value="{{reservation.phoneCountryCode}}" />
                                        <input type="tel" id="phone" name="phone" value="{{reservation.phone}}" data-phone="{{reservation.phone}}" class="form-control decimal-only" data-additional-allowed-characters="- " placeholder="{{{message " cms_reservation_phone "}}} *" />                                        {{#reservation.errors}} {{#ifequal field "phone"}}
                                        <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                                    </div>
                                </div>
                                <div class="col-sm-12">
                    ...
                    <i class="feather-icon icon-chevron-down v-middle m-t-n-3xxs m-l-sm"></i>
                                        ...
                                        <textarea id="comment" class="form-control" rows="5" placeholder="{{message " cms_reservation_widget_comment_placeholder "}}">{{reservation.comment}}</textarea> {{#reservation.errors}} {{#ifequal field "comment"}}
                                        <span class="help-block">{{error}}</span> {{/ifequal}} {{/reservation.errors}}
                                    </div>
                                </div>
                                {{#moreThanOneNotNull 1 reservation.settings.termsOfServiceUrl reservation.settings.termsOfServiceContent reservation.settings.privacyPolicyUrl reservation.settings.privacyPolicyContent}}
                        ...
                        <span>{{message "cms_order_termsOfService"}}</span>
                        {{#if reservation.settings.termsOfServiceUrl}}
                            <a href="https://avocado-en.orderwebsite.com/{{{reservation.settings.termsOfServiceUrl}}}" target="_blank">
                                {{message "cms_order_termsOfServiceUrl"}}
                            </a>
                        {{else}}
                            {{#if reservation.settings.termsOfServiceContent}}
                                <a href="index.html#" id="_show-terms-of-service-reservation">
                                    {{message "cms_order_termsOfServiceUrl"}}
                                </a>
                            {{/if}}
                        {{/if}}
                        ...
                        {{/moreThanOneNotNull}}
                        {{#if reservation.settings.privacyPolicyUrl}}
                            <a href="https://avocado-en.orderwebsite.com/{{{reservation.settings.privacyPolicyUrl}}}" target="_blank">
                                {{message "cms_order_privacyPolicyUrl"}}
                            </a>
                        {{else}}
                            {{#if reservation.settings.privacyPolicyContent}}
                                <a href="index.html#" id="_show-privacy-policy">
                                    {{message "cms_order_privacyPolicyUrl"}}
                                </a>
                                <div style="display: none;" id="_privacy-policy-content">
                                    {{{reservation.settings.privacyPolicyContent}}}
                    ...
                    <span>{{message "cms_gdpr_reservation_form_sms"}}</span>
                        ...
                        <a class="pointer" onclick="jQuery('.booking-gdpr').slideToggle(); return false;">{{message "cms_gdpr_order_form_gdpr_information"}}&nbsp;<i class="fa fa-angle-down"></i></a>
                                ...
                                <!-- GDPR -->
                                <div class="col-sm-12">
                                    <a href="" class="btn btn-upmenu btn-block btn-lg {{colorVariant}} _booking-form-submit" {{#if editMode}} disabled="disabled" {{/if}} {{#ifequal colorVariant "color-custom"}} style="background-color: {{color}}" {{/ifequal}}>
            ...
            {{/unless}} {{/ifequal}} {{/restaurants}} {{/ifequal}} {{/ifequal}} {{/if}} {{#restaurants}} {{#ifequal ../reservation.restaurantId id}} {{#if onlineBookingEnabled}} {{else}}
            <div class="row m-t">
                <div class="col-sm-12 text-center">
...
{{#if popups}}
        <div class="popups-holder">
            ...
            <div class="popup-type-vertical">
                ...
                {{else}}
                <div class="popups-vertical-left" style="background-image: url('https://avocado-en.orderwebsite.com/{{../site.assets_path}}/{{filename}}?v={{../site.assets_version}}');"></div>
                {{/ifequal}}
                <div class="popups-vertical-right">
                    ...
                    {{/if}} {{#if showButton}} {{#if buttonLabel}}
                    <a class="btn btn-block btn-upmenu" {{#ifequal urlType "navigation"}} href="{{urlPage}}" {{/ifequal}} {{#ifequal urlType "external"}} href="{{url}}" {{/ifequal}} {{#ifequal urlType "file"}} href="{{../site.assets_path}}/{{referenceFilename}}?v={{../site.assets_version}}"
                        {{/ifequal}} {{#if newWindow}} target="_blank" {{/if}}>
                                    {{buttonLabel}}
                                </a> {{/if}} {{/if}}
                </div>
            </div>
            {{/ifequal}} {{#ifequal template "horizontal"}}
            <div class="item popup-type-horizontal">
                ...
                {{else}}
                <div class="popups-horizontal-top" style="background-image: url('https://avocado-en.orderwebsite.com/{{../site.assets_path}}/{{filename}}?v={{../site.assets_version}}');"></div>
                {{/ifequal}}
            ...
            {{/ifequal}} {{#ifequal template "image"}} {{#ifequal filename ""}}
            ...
            {{else}}
            <div class="popup-type-image" style="background-image: url('https://avocado-en.orderwebsite.com/{{../site.assets_path}}/{{filename}}?v={{../site.assets_version}}');"></div>
...
// English
        ...
        I18n.translations['en'] = {
            ...
            "cms_order_email_popover_login": "You have an account. <a href='index.html#' class='_open-login-modal'>Sign in</a>.",
            ...
            "email_payout_footer3": "For more information about how we process data, please see our <a href="
            https: //avocado-en.orderwebsite.com/\&quot;https://www.upmenu.com/privacy-policy/\&quot;" target=\"_blank\">Privacy Policy</a>.",
            ...
            "email_payout_footer2": "To customize which email notifications you receive, visit <a href="
            https: //avocado-en.orderwebsite.com/\&quot;{{0}}\&quot;" target=\"_blank\">Notifications</a> in your admin panel.",
            ...
            "cms_email_weekly_summary_last_week_no_orders": "Hi, It looks like there was no order last week <a href="
            https: //avocado-en.orderwebsite.com/\&quot;http://www.upmenu.com/kontakt\&quot;" target=\"_blank\">Call me and together we will think about a solution :)</a>",
            ...
            "cms_email_campgain_unsub": "You received this message because you have subscribed to our newsletter. <br>You don't want this type of message? -  <a href="
            https: //avocado-en.orderwebsite.com/\&quot;{{0}}\&quot;" target=\"_blank\">Click here</a> <br>",
            ...
            "cms_email_weekly_summary_orders_increased": "That's great that the amount of orders is inreasing. Keep it up! Remember that if there are any problems, I'm here to help you. <a href="
            https: //avocado-en.orderwebsite.com/\&quot;http://www.upmenu.com/kontakt\&quot;" target=\"_blank\">Let me know</a>.",
            ...
            "cms_email_weekly_summary_15_orders": "Wow! Last week was great about the order number. Think about what caused this increase <a href="
            https: //avocado-en.orderwebsite.com/\&quot;http://www.upmenu.com/kontakt\&quot;" target=\"_blank\">Also, you can call me and we will think about it together </a>",
            ...
            "cms_email_weekly_summary_orders_decreased": "Hmm ... There were fewer orders last week. Think about what it may be like to try to improve the situation this week? <a href="
            https: //avocado-en.orderwebsite.com/\&quot;http://www.upmenu.com/kontakt\&quot;" target=\"_blank\">Let me know</a> and we can think about it together",
...
jQuery.cookie('ab_test_version', null, {
        ...
        (function(d, s, c) {
            ...
            j.src = 'https://static.cdn-upm.com/media/1202/vendor/elastic-apm/elastic-apm-rum.umd.min.js'
            j.onload = function() {
                elasticApm.init(c)
            }
        ...
        com.upmenu.staticPath = 'https://static.cdn-upm.com/media/1202';
        com.upmenu.staticPathTheme = 'https://cs.cdn-upm.com/themes/98dfb947-4a04-11ed-8bca-525400080621/assets-6';
        ...
        com.upmenu.siteId = '98dfb947-4a04-11ed-8bca-525400080621';
        com.upmenu.socialLoginEnabled = 'true';
        com.upmenu.siteLanguageId = '98eaff42-4a04-11ed-8bca-525400080621';
        com.upmenu.siteName = 'Avocado';
        com.upmenu.pageId = 'd0fdfdc7-7484-11ed-8bca-525400080621';
        com.upmenu.pageTranslationId = 'd0ff00b9-7484-11ed-8bca-525400080621';
        com.upmenu.restaurantId = '98edd773-4a04-11ed-8bca-525400080621';
        ...
        com.upmenu.restaurant = {
            "id": "98edd773-4a04-11ed-8bca-525400080621",
            "name": "Avocado",
            "url": "https://avocado-en.orderwebsite.com/menu/menu",
            "title": "Zamów online",
            "keywords": null,
            "description": null,
            "noIndex": false,
            ...
            "phone2": null,
            "mobilePhone": null,
            "email": "contact@upmenu.com",
            "avarageDeliveryTime": null,
            "averageTakeawayOnsiteTime": null,
            "minOrderPrice": null,
            "minMinOrderPrice": null,
            "maxMinOrderPrice": null,
            "deliveryCost": null,
            ...
            "onlyTableOrdering": null,
            "futureOrdering": true,
            "futureOrderingMinDays": 0,
            "futureOrderingMaxDays": 14,
            "openingHours": {
                "mondayOpen": "12:00 AM",
                "mondayClose": "11:59 PM",
                "monday": false,
                "tuesdayOpen": "12:00 AM",
                "tuesdayClose": "11:59 PM",
                "tuesday": false,
                "wednesdayOpen": "12:00 AM",
                "wednesdayClose": "11:59 PM",
                "wednesday": false,
                "thursdayOpen": "12:00 AM",
                "thursdayClose": "11:59 PM",
                "thursday": false,
                "fridayOpen": "12:00 AM",
                "fridayClose": "11:59 PM",
                "friday": false,
                "saturdayOpen": "12:00 AM",
                "saturdayClose": "11:59 PM",
                "saturday": false,
                "sundayOpen": "12:00 AM",
                "sundayClose": "11:59 PM",
                "sunday": false
            },
            "openingHoursRange": [{
                "from": "MONDAY",
            ...
            "onlineOrderingDisabledDescription": null,
            "onlineBookingEnabled": true,
            "onlineBookingDisabledDescription": null,
            "tips": true,
            "tipRequired": false,
            "tipPercentage": [0, 10, 20],
            "facebook": null,
            "twitter": null,
            "instagram": null,
            "tiktok": null,
            ...
            "tripAdvisor": null,
            "attributes": null,
            "takeAwayMinPrice": null,
            "onSiteMinPrice": null,
            "minOrderPriceInRestaurant": null,
            "maxOrderPriceInRestaurant": null,
            "formattedAddress": "",
            "averageGrade": "0.00",
            "deliveryRating": "0.00",
            "foodRating": "0.00",
            "priceRating": "0",
            "publishedRatings": false,
        ...
        com.upmenu.site = {
            "name": "Avocado",
            "languages": [{
                "id": "98eaff42-4a04-11ed-8bca-525400080621",
                "code": "en",
                "title": "en",
                "url": "https://avocado-en.orderwebsite.com/",
                "selected": true,
            ...
            "timezone": "America/New_York",
            "countryCode": "US",
            "assets_path": "https://cs.cdn-upm.com/themes/98dfb947-4a04-11ed-8bca-525400080621/assets-6",
            "assets_url": "https://cs.cdn-upm.com/themes/98dfb947-4a04-11ed-8bca-525400080621/assets-6",
            "dynamic_assets_path": "/dynamict/themes/98dfb947-4a04-11ed-8bca-525400080621/assets-6",
            "assets_version": 0,
            "theme_assets_version": 6,
            "scripts_path": "https://cs.cdn-upm.com/themes/98dfb947-4a04-11ed-8bca-525400080621/scripts-6",
            "scripts_url": "https://cs.cdn-upm.com/themes/98dfb947-4a04-11ed-8bca-525400080621/scripts-6",
            "dynamic_scripts_path": "/dynamict/themes/98dfb947-4a04-11ed-8bca-525400080621/scripts-6",
            "styles_path": "https://cs.cdn-upm.com/themes/98dfb947-4a04-11ed-8bca-525400080621/styles-6",
            "styles_url": "https://cs.cdn-upm.com/themes/98dfb947-4a04-11ed-8bca-525400080621/styles-6",
            "dynamic_styles_path": "/dynamict/themes/98dfb947-4a04-11ed-8bca-525400080621/styles-6",
            "dynamic_less_path": "/dynamict/themes/less/98dfb947-4a04-11ed-8bca-525400080621/styles-6",
            "cms4_dynamic_less_path": "/dynamict/themes/less/v4/98dfb947-4a04-11ed-8bca-525400080621/styles-6",
            "cms4_dynamic_no_compile_less_path": "/dynamict/themes/less/v4/edit/98dfb947-4a04-11ed-8bca-525400080621/styles-6",
            "google_analytics_ua": [],
            "google_analytics_g": null,
            ...
            "logoImageUrl": "",
            "mobileIconUrl": null,
            "cookieLawContent": null,
            "cookieLabel": null,
            "contact_email": null,
            "gdprContactContent": null,
            "gdprNewsletterContent": null,
            "gdprRegistrationContent": null,
            "poweredByLogo": true,
            "affiliateBanner": false,
            "affiliateBannerModal": false,
            "affiliateBannerId": null,
            "geocodeFormat": "{street*} {postalCode} {city*} {region*}",
            "themeStoreType": "WEBSITE",
            "hideAddressSearchOnRestaurantList": false,
            "coverUrl": null,
            "domain": "avocado-en.orderwebsite.com",
            "opportunityVersion": "COMPLETED",
            "onboarding": false,
            "onboardingSummary": null,
            "onboardingWidgetState": "OPEN"
        };
        com.upmenu.customer = {
            "id": null,
            "registered": null,
        ...
        com.upmenu.theme_JSON = JSON.parse("{\n  \"id\" : \"ff7d041e-efc8-4902-92e7-aef0b83f846d\",\n  \"globalStyles\" : {\n    \"borderColor\" : \"#f7f1f4\",\n    \"color\" : \"#403f4b\",\n    \"footer\" : {\n      \"preset\" : \"preset-3\",\n      \"showLogo\" : \"true\",\n      \"backgroundColor\" : \"rgba(247, 241, 244, 1)\",\n      \"backgroundColorVariant\" : \"color-5\",\n      \"backgroundColorOpacity\" : \"100%\",\n      \"color\" : \"#111\",\n      \"colorVariant\" : \"color-3\",\n      \"linkColor\" : \"rgba(0, 0, 0, 1)\",\n      \"linkColorVariant\" : \"color-3\",\n      \"logoSize\" : \"standard\",\n      \"logoWidth\" : 160,\n      \"logoImage\" : \"logo.png\",\n      \"fontSize\" : \"16\",\n      \"fontWeight\" : \"500\",\n      \"fontWeightPreset\" : \"standard\",\n      \"link\" : {\n        \"color\" : \"#111\",\n        \"colorHover\" : \"#8B38CB\"\n      },\n      \"logoHeight\" : \"36\"\n    },\n    \"backgroundImage\" : \"\",\n    \"fontSizePreset\" : \"medium\",\n    \"fillColor\" : \"#d1d6e0\",\n    \"button\" : {\n      \"borderRadius\" : \"32px\",\n      \"preset\" : \"preset-3\"\n    },\n    \"fontFamily\" : \"Inter\",\n    \"fontWeightPreset\" : \"standard\",\n    \"mainColor\" : \"#61de55\",\n    \"animations\" : {\n      \"sectionReveal\" : \"fade-in\"\n    },\n    \"faviconImage\" : \"favicon.png\",\n    \"backgroundSize\" : \"cover\",\n    \"backgroundType\" : \"color\",\n    \"fontWeight\" : \"500\",\n    \"backgroundColor\" : \"#ffffff\",\n    \"accentColor\" : \"#252a4c\",\n    \"colorPreset\" : \"custom\",\n    \"menu\" : {\n      \"showImages\" : \"true\",\n      \"layout\" : \"box\",\n      \"theme\" : \"light\",\n      \"columns\" : 3,\n      \"categories\" : \"top\",\n      \"foldCategories\" : \"false\",\n      \"groupVariants\" : \"true\",\n      \"promotionsLayout\" : \"box\",\n      \"restaurantsLayout\" : \"list\",\n      \"hideRestaurants\" : \"false\",\n      \"changeRestaurantVisible\" : \"false\",\n      \"columnsMobile\" : \"2\"\n    },\n    \"fontName\" : \"Inter\",\n    \"fontPreset\" : \"custom\",\n    \"borderRadius\" : \"8\",\n    \"headings\" : {\n      \"color\" : \"#000000\",\n      \"fontFamily\" : \"Sora\",\n      \"fontWeight\" : \"500\",\n      \"fontSize\" : \"24px\",\n      \"fontName\" : \"Sora\",\n      \"fontWeightPreset\" : \"standard\"\n    },\n    \"header\" : {\n      \"backgroundColor\" : \"rgba(247,241,244,1)\",\n      \"backgroundColorVariant\" : \"color-custom\",\n      \"backgroundColorOpacity\" : \"100\",\n      \"preset\" : \"preset-1\",\n      \"showLogo\" : \"true\",\n      \"logoSize\" : \"custom\",\n      \"logoWidth\" : \"200\",\n      \"fontSize\" : \"18\",\n      \"fontWeight\" : \"500\",\n      \"logoImage\" : \"logo.png\",\n      \"faviconImage\" : \"\",\n      \"fontWeightPreset\" : \"standard\",\n      \"buttonColor\" : \"rgba(97, 222, 86, 1)\",\n      \"buttonColorVariant\" : \"color-0\",\n      \"linkColor\" : \"rgba(0, 0, 0, 1)\",\n      \"linkColorVariant\" : \"color-3\",\n      \"logoHeight\" : \"45\"\n    },\n    \"fontSize\" : \"16px\",\n    \"colorPalette\" : [ {\n      \"backgroundColor\" : \"#61de55\",\n      \"colorName\" : \"color-0\"\n    }, {\n      \"backgroundColor\" : \"#252a4c\",\n      \"colorName\" : \"color-1\"\n    }, {\n      \"backgroundColor\" : \"#d1d6e0\",\n      \"colorName\" : \"color-2\"\n    }, {\n      \"backgroundColor\" : \"#000000\",\n      \"colorName\" : \"color-3\"\n    }, {\n      \"backgroundColor\" : \"#403f4b\",\n      \"colorName\" : \"color-4\"\n    }, {\n      \"backgroundColor\" : \"#f7f1f4\",\n      \"colorName\" : \"color-5\"\n    }, {\n      \"backgroundColor\" : \"#ffffff\",\n      \"colorName\" : \"color-6\"\n    } ]\n  },\n  \"sections\" : [ {\n    \"height\" : \"custom\",\n    \"customHeight\" : \"120\",\n    \"width\" : \"container\",\n    \"alignment\" : \"middle\",\n    \"invertedColumns\" : \"false\",\n    \"columns\" : [ {\n      \"width\" : \"6\",\n      \"widget\" : [ {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w3d06ac28-a8df-456e-9fca-b7797e4eaddb\",\n        \"content\" : \"<h1>Healthy, colorful, <span style=\\\"color: rgb(97, 222, 85);\\\">AVOCADO!</span></h1>\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w9401966d-5dfa-4d0c-bb65-6c554df8649c\",\n        \"content\" : \"<h4>Enjoy our avocado specialties from Monday to Sunday! </h4>\"\n      }, {\n        \"type\" : \"button\",\n        \"name\" : \"Button\",\n        \"buttonType\" : \"standard\",\n        \"label\" : \"Order online\",\n        \"icon\" : \"false\",\n        \"iconName\" : \"fa-star-o\",\n        \"iconNameText\" : \"Outline star\",\n        \"iconPosition\" : \"beforeText\",\n        \"buttonPosition\" : \"left\",\n        \"buttonSize\" : \"large\",\n        \"referenceType\" : \"navigation\",\n        \"externalLink\" : \"\",\n        \"link\" : \"/menu\",\n        \"openNewWindow\" : \"false\",\n        \"style\" : {\n          \"colorBg\" : \"#61de56\",\n          \"colorVariantBg\" : \"color-0\",\n          \"colorText\" : \"\",\n          \"colorVariantText\" : \"color-6\"\n        },\n        \"id\" : \"w365a5d3a-5fae-4353-87e3-a0b7e578d626\",\n        \"page\" : \"/menu\"\n      } ]\n    }, {\n      \"width\" : \"6\",\n      \"widget\" : [ {\n        \"type\" : \"image\",\n        \"name\" : \"Image\",\n        \"url\" : \"hero.png\",\n        \"imageAlt\" : \"Image\",\n        \"referenceType\" : \"none\",\n        \"externalLink\" : \"\",\n        \"link\" : \"\",\n        \"openNewWindow\" : \"false\",\n        \"content\" : \"\",\n        \"imagePosition\" : \"center\",\n        \"imageSize\" : \"auto\",\n        \"style\" : {\n          \"borderRadius\" : {\n            \"preset\" : \"individual\",\n            \"all\" : \"500\",\n            \"individual\" : [ \"80\", 0, \"80\", 0 ]\n          },\n          \"width\" : \"500\",\n          \"measurement\" : \"px\"\n        },\n        \"id\" : \"w685890fd-30fa-4067-a462-67ba181411f6\"\n      } ]\n    } ],\n    \"styles\" : {\n      \"backgroundColor\" : \"rgba(255,255,255,0)\",\n      \"backgroundColorVariant\" : \"color-2\",\n      \"backgroundOpacity\" : \"0\",\n      \"backgroundAttachment\" : \"fixed\",\n      \"backgroundImage\" : \"wave2.png\",\n      \"backgroundPosition\" : \"top\"\n    },\n    \"id\" : \"w592e4a3a-ce01-4e24-ae40-6db5fabc0285\"\n  }, {\n    \"height\" : \"custom\",\n    \"customHeight\" : \"120\",\n    \"width\" : \"container\",\n    \"alignment\" : \"middle\",\n    \"invertedColumns\" : true,\n    \"columns\" : [ {\n      \"width\" : \"6\",\n      \"widget\" : [ {\n        \"type\" : \"image\",\n        \"name\" : \"Image\",\n        \"url\" : \"vegan2.jpg\",\n        \"imageAlt\" : \"Image\",\n        \"referenceType\" : \"none\",\n        \"externalLink\" : \"\",\n        \"link\" : \"\",\n        \"openNewWindow\" : \"false\",\n        \"content\" : \"\",\n        \"style\" : {\n          \"borderRadius\" : {\n            \"preset\" : \"individual\",\n            \"all\" : \"89\",\n            \"individual\" : [ \"200\", \"200\", \"90\", \"90\" ]\n          },\n          \"height\" : \"500\",\n          \"width\" : \"80\",\n          \"measurement\" : \"%\"\n        },\n        \"id\" : \"w11a7750a-e862-4076-af52-b4ef54b01b43\",\n        \"imageSize\" : \"custom\",\n        \"imagePosition\" : \"center\"\n      } ]\n    }, {\n      \"width\" : \"6\",\n      \"widget\" : [ {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w363f66b6-d8d4-45de-8596-97980014fdd1\",\n        \"content\" : \"<h4><span style=\\\"color: rgb(255, 255, 255);\\\">Looking for something delicious and fit? You will love our restaurant!</span></h4>\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w13827e81-cbed-4def-871e-3b2c3bd72570\",\n        \"content\" : \"<h2><span style=\\\"color: rgb(255, 255, 255);\\\">We invite you to AVOCADO! Here you will always eat something tasty </span></h2>\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w75c26d31-e2d5-49b4-9ce0-aa7065f5c36e\",\n        \"content\" : \"<p><span style=\\\"color: rgb(255, 255, 255);\\\">Are you ready for an explosion of flavor? At our restaurant, we combine our two passions: love for healthy living and delicious food. How is this possible? We opt for natural and fresh ingredients and unique spices. At its heart is the avocado!</span></p>\"\n      }, {\n        \"type\" : \"spacer\",\n        \"name\" : \"Spacer\",\n        \"preset\" : \"small\",\n        \"height\" : \"50\",\n        \"id\" : \"w0131aa62-1601-4f88-ae66-f89a905060ca\"\n      }, {\n        \"type\" : \"button\",\n        \"name\" : \"Button\",\n        \"buttonType\" : \"outline\",\n        \"label\" : \"Order now\",\n        \"icon\" : \"false\",\n        \"iconName\" : \"fa-star-o\",\n        \"iconNameText\" : \"Outline star\",\n        \"iconPosition\" : \"beforeText\",\n        \"buttonPosition\" : \"left\",\n        \"referenceType\" : \"navigation\",\n        \"externalLink\" : \"\",\n        \"link\" : \"/menu\",\n        \"openNewWindow\" : \"false\",\n        \"style\" : {\n          \"colorBg\" : \"#ffffff\",\n          \"colorVariantBg\" : \"color-6\",\n          \"colorText\" : \"#ffffff\",\n          \"colorVariantText\" : \"color-6\"\n        },\n        \"id\" : \"wfa5398e9-5e56-4e9d-8e1c-74d3f961ad1b\",\n        \"buttonSize\" : \"large\",\n        \"page\" : \"/menu\"\n      } ]\n    } ],\n    \"styles\" : {\n      \"backgroundColor\" : \"rgba(97, 222, 86, 0)\",\n      \"backgroundColorVariant\" : \"color-0\",\n      \"backgroundOpacity\" : \"0\",\n      \"backgroundAttachment\" : \"fixed\",\n      \"backgroundImage\" : \"bg2.jpg\",\n      \"backgroundPosition\" : \"center\"\n    },\n    \"id\" : \"w65613be3-922a-4555-afb3-dbc05494c656\"\n  }, {\n    \"height\" : \"custom\",\n    \"customHeight\" : \"100\",\n    \"width\" : \"container\",\n    \"alignment\" : \"middle\",\n    \"invertedColumns\" : \"false\",\n    \"columns\" : [ {\n      \"width\" : \"4\",\n      \"widget\" : [ {\n        \"type\" : \"icon_box\",\n        \"name\" : \"Icon box\",\n        \"iconName\" : \"fa-coffee\",\n        \"iconNameText\" : \"Coffee\",\n        \"iconBoxAlignment\" : \"vertical\",\n        \"iconBoxPosition\" : \"center\",\n        \"referenceType\" : \"none\",\n        \"externalLink\" : \"\",\n        \"link\" : \"\",\n        \"openNewWindow\" : \"false\",\n        \"titleBox\" : \"Aromatic coffee\",\n        \"textBox\" : \"We carefully select the coffee beans.\",\n        \"style\" : {\n          \"colorIcon\" : \"#004dff\",\n          \"colorVariantIcon\" : \"color-0\",\n          \"colorText\" : \"#000000\",\n          \"colorVariantText\" : \"color-3\",\n          \"sizeIcon\" : \"72\"\n        },\n        \"id\" : \"w3cd8d462-f864-4ae9-b249-5ab0ab33bc70\"\n      } ]\n    }, {\n      \"width\" : \"4\",\n      \"widget\" : [ {\n        \"type\" : \"icon_box\",\n        \"name\" : \"Icon box\",\n        \"iconName\" : \"fa-bed\",\n        \"iconNameText\" : \"Bed\",\n        \"iconBoxAlignment\" : \"vertical\",\n        \"iconBoxPosition\" : \"center\",\n        \"referenceType\" : \"none\",\n        \"externalLink\" : \"\",\n        \"link\" : \"\",\n        \"openNewWindow\" : \"false\",\n        \"titleBox\" : \"Comfort and chill  \",\n        \"textBox\" : \"Our comfortable couches will make you forget about your troubles. \",\n        \"style\" : {\n          \"colorIcon\" : \"#967d47\",\n          \"colorVariantIcon\" : \"color-0\",\n          \"colorText\" : \"#111111\",\n          \"colorVariantText\" : \"color-3\",\n          \"sizeIcon\" : \"72\"\n        },\n        \"id\" : \"w6cdf9fea-399a-4314-89b4-d3e8a64a4313\"\n      } ]\n    }, {\n      \"width\" : \"4\",\n      \"widget\" : [ {\n        \"type\" : \"icon_box\",\n        \"name\" : \"Icon box\",\n        \"iconName\" : \"fa-cutlery\",\n        \"iconNameText\" : \"Cutlery\",\n        \"iconBoxAlignment\" : \"vertical\",\n        \"iconBoxPosition\" : \"center\",\n        \"referenceType\" : \"none\",\n        \"externalLink\" : \"\",\n        \"link\" : \"\",\n        \"openNewWindow\" : \"false\",\n        \"titleBox\" : \"Healthy food\",\n        \"textBox\" : \"We cook healthily and tasty. \",\n        \"style\" : {\n          \"colorIcon\" : \"#967d47\",\n          \"colorVariantIcon\" : \"color-0\",\n          \"colorText\" : \"#111111\",\n          \"colorVariantText\" : \"color-3\",\n          \"sizeIcon\" : \"72\"\n        },\n        \"id\" : \"w0a127ce1-b5bb-440d-beb6-911c681767a9\"\n      } ]\n    } ],\n    \"styles\" : {\n      \"backgroundColor\" : \"rgba(254,248,236,1)\",\n      \"backgroundColorVariant\" : \"color-custom\",\n      \"backgroundOpacity\" : \"100\",\n      \"backgroundAttachment\" : \"scroll\"\n    },\n    \"id\" : \"w1c75aa64-f60b-4e24-a7e1-2120965b8989\"\n  }, {\n    \"height\" : \"standard\",\n    \"customHeight\" : \"64\",\n    \"width\" : \"container\",\n    \"alignment\" : \"middle\",\n    \"invertedColumns\" : \"false\",\n    \"columns\" : [ {\n      \"width\" : \"3\",\n      \"widget\" : [ {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w76988be9-ff27-4f17-9a87-0a0d609969af\",\n        \"content\" : \"<h3 class=\\\"ql-align-center\\\"><span style=\\\"color: rgb(97, 222, 85);\\\">Healthy and delicious food</span></h3>\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"wa6e1ef53-24b1-4993-879e-c53ab15e13da\",\n        \"content\" : \"<p class=\\\"ql-align-center\\\">We combine health with taste. We cook healthily, and all dishes on our menu are low in calories. </p>\"\n      }, {\n        \"type\" : \"spacer\",\n        \"name\" : \"Odstęp\",\n        \"preset\" : \"custom\",\n        \"height\" : \"90\",\n        \"id\" : \"w2e535143-cb9b-4340-81ea-7c7e4ca2ab76\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"wcf0c390b-4580-4bd5-a08b-b501a7e907a6\",\n        \"content\" : \"<h3 class=\\\"ql-align-center\\\"><span style=\\\"color: rgb(97, 222, 85);\\\">Sugar-free sweet desserts</span></h3>\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w0bc8d4f6-c58e-4f53-b672-cb448729ec82\",\n        \"content\" : \"<p class=\\\"ql-align-center\\\">Is it possible to eat sweets while on a diet? Yes! All our desserts are healthy! Instead of sugar, we use the natural sweetness of fruits. </p>\"\n      } ]\n    }, {\n      \"width\" : \"6\",\n      \"widget\" : [ {\n        \"type\" : \"image\",\n        \"name\" : \"Image\",\n        \"url\" : \"vegan.jpg\",\n        \"imageAlt\" : \"Image\",\n        \"referenceType\" : \"none\",\n        \"externalLink\" : \"\",\n        \"link\" : \"\",\n        \"openNewWindow\" : \"false\",\n        \"content\" : \"\",\n        \"style\" : {\n          \"borderRadius\" : {\n            \"preset\" : \"all\",\n            \"all\" : 0,\n            \"individual\" : [ 0, 0, 0, 0 ]\n          },\n          \"height\" : \"500\"\n        },\n        \"id\" : \"we541793f-2d61-416e-bd26-ecda9187233d\"\n      } ]\n    }, {\n      \"width\" : \"3\",\n      \"widget\" : [ {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w2c39021a-ad5a-4a2c-8591-bf3a9ebed012\",\n        \"content\" : \"<h3 class=\\\"ql-align-center\\\"><span style=\\\"color: rgb(97, 222, 85);\\\">Aromatic coffee</span></h3>\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w6342be13-5485-4b85-b34d-0c086611b3ef\",\n        \"content\" : \"<p class=\\\"ql-align-center\\\">Coffee from freshly roasted and carefully selected beans tastes delicious every day. Come and try it!</p>\"\n      }, {\n        \"type\" : \"spacer\",\n        \"name\" : \"Odstęp\",\n        \"preset\" : \"custom\",\n        \"height\" : \"90\",\n        \"id\" : \"we92b3805-9d7d-41e9-9fb7-327e00dacab0\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"wb47e0eb0-fe2a-4220-96d5-d54a66a501f2\",\n        \"content\" : \"<h3 class=\\\"ql-align-center\\\"><span style=\\\"color: rgb(97, 222, 85);\\\">The power of freshness  </span></h3>\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w06d9f12e-4ce4-4613-b0dc-3a4a0667bc2e\",\n        \"content\" : \"<p class=\\\"ql-align-center\\\">We carefully select our ingredients. We only order fresh and quality products from local suppliers, including vegetables and fruits. </p>\"\n      } ]\n    } ],\n    \"styles\" : {\n      \"backgroundColor\" : \"rgba(255,255,255,0)\",\n      \"backgroundColorVariant\" : \"color-2\",\n      \"backgroundOpacity\" : \"0\",\n      \"backgroundAttachment\" : \"scroll\"\n    },\n    \"id\" : \"w41cf9306-8182-490f-8e88-bf7851222cfe\"\n  }, {\n    \"height\" : \"custom\",\n    \"customHeight\" : \"120\",\n    \"width\" : \"container\",\n    \"alignment\" : \"middle\",\n    \"invertedColumns\" : false,\n    \"columns\" : [ {\n      \"width\" : \"6\",\n      \"widget\" : [ {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"w4256fad9-7d20-405a-bb89-c9d9b67a6463\",\n        \"content\" : \"<h4><span style=\\\"color: rgb(97, 222, 85);\\\">Authentic fit food</span></h4>\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"wfd76747a-3802-44fe-a129-46e8fa867186\",\n        \"content\" : \"<h2><span style=\\\"color: rgb(255, 255, 255);\\\">Avocado is our superhero! </span></h2>\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Text\",\n        \"id\" : \"we9f28ca2-7893-4b55-8ff9-2d0863458cca\",\n        \"content\" : \"<p><span style=\\\"color: rgb(255, 255, 255);\\\">We focus on health and taste. In the heart of our kitchen, we put avocado, the healthiest fruit in the world, which is a real mine of vitamins and nutrients! All our dishes are created based on this beauty. </span></p>\"\n      }, {\n        \"type\" : \"spacer\",\n        \"name\" : \"Spacer\",\n        \"preset\" : \"custom\",\n        \"height\" : \"15\",\n        \"id\" : \"wa8b75aab-cde8-4374-8a54-b9016c76a457\"\n      }, {\n        \"type\" : \"button\",\n        \"name\" : \"Button\",\n        \"buttonType\" : \"outline\",\n        \"label\" : \"Order now\",\n        \"icon\" : \"false\",\n        \"iconName\" : \"fa-star-o\",\n        \"iconNameText\" : \"Outline star\",\n        \"iconPosition\" : \"beforeText\",\n        \"buttonPosition\" : \"left\",\n        \"referenceType\" : \"navigation\",\n        \"externalLink\" : \"\",\n        \"link\" : \"/menu\",\n        \"openNewWindow\" : \"false\",\n        \"style\" : {\n          \"colorBg\" : \"#967d47\",\n          \"colorVariantBg\" : \"color-0\",\n          \"colorText\" : \"#967d47\",\n          \"colorVariantText\" : \"color-0\"\n        },\n        \"id\" : \"w8cc831ed-eccc-48b6-98d0-35633d887fdd\",\n        \"buttonSize\" : \"large\",\n        \"page\" : \"/menu\"\n      } ]\n    }, {\n      \"width\" : \"6\",\n      \"widget\" : [ {\n        \"type\" : \"image\",\n        \"name\" : \"Image\",\n        \"url\" : \"person.jpg\",\n        \"imageAlt\" : \"Image\",\n        \"referenceType\" : \"none\",\n        \"externalLink\" : \"\",\n        \"link\" : \"\",\n        \"openNewWindow\" : \"false\",\n        \"content\" : \"\",\n        \"style\" : {\n          \"borderRadius\" : {\n            \"preset\" : \"individual\",\n            \"all\" : 0,\n            \"individual\" : [ \"200\", \"200\", \"0\", \"0\" ]\n          },\n          \"height\" : \"500\",\n          \"width\" : \"80\",\n          \"measurement\" : \"%\"\n        },\n        \"id\" : \"w015001d6-3f1b-4f0b-a58d-d78dc59f80c8\",\n        \"imageSize\" : \"custom\",\n        \"imagePosition\" : \"center\"\n      } ]\n    } ],\n    \"styles\" : {\n      \"backgroundColor\" : \"rgba(37, 42, 76, 1.2)\",\n      \"backgroundColorVariant\" : \"color-1\",\n      \"backgroundOpacity\" : \"120\",\n      \"backgroundAttachment\" : \"scroll\"\n    },\n    \"id\" : \"wb558928a-80de-4def-a26e-c1ad8d3b1455\"\n  }, {\n    \"height\" : \"standard\",\n    \"customHeight\" : \"64\",\n    \"width\" : \"container-fluid\",\n    \"alignment\" : \"middle\",\n    \"invertedColumns\" : \"false\",\n    \"columns\" : [ {\n      \"width\" : \"3\",\n      \"widget\" : [ {\n        \"type\" : \"image\",\n        \"name\" : \"Obraz\",\n        \"url\" : \"vegan_AFouckhG.jpg\",\n        \"imageAlt\" : \"Image\",\n        \"referenceType\" : \"none\",\n        \"externalLink\" : \"\",\n        \"link\" : \"\",\n        \"openNewWindow\" : \"false\",\n        \"content\" : \"\",\n        \"imagePosition\" : \"center\",\n        \"imageSize\" : \"auto\",\n        \"style\" : {\n          \"borderRadius\" : {\n            \"preset\" : \"all\",\n            \"all\" : \"150\",\n            \"individual\" : [ 0, 0, 0, 0 ]\n          },\n          \"width\" : \"400\",\n          \"measurement\" : \"px\"\n        },\n        \"id\" : \"w355e1c64-ec30-42cb-8b8c-96444ba9b23c\"\n      } ]\n    }, {\n      \"width\" : \"6\",\n      \"widget\" : [ {\n        \"type\" : \"text\",\n        \"name\" : \"Tekst\",\n        \"id\" : \"w13a5dc71-69eb-49ea-8738-4160c2bcd6dd\",\n        \"content\" : \"<h2 class=\\\"ql-align-center\\\">How about healthy meal delivery service? </h2>\"\n      }, {\n        \"type\" : \"text\",\n        \"name\" : \"Tekst\",\n        \"id\" : \"w9895c903-5ac9-49ae-ba74-8851a3f5ca1b\",\n        \"content\" : \"<h4 class=\\\"ql-align-center\\\">You can order a catering service from us. What does this mean? Why is it worth it? Every day, we will deliver your meals according to your diet and culinary preferences. Contact us for more details. </h4>\"\n      }, {\n        \"type\" : \"spacer\",\n        \"name\" : \"Odstęp\",\n        \"preset\" : \"custom\",\n        \"height\" : \"24\",\n        \"id\" : \"w869064ed-91e3-4b50-9987-31f3e704374c\"\n      }, {\n        \"type\" : \"button\",\n        \"name\" : \"Przycisk\",\n        \"buttonType\" : \"standard\",\n        \"label\" : \"Order online\",\n        \"icon\" : \"false\",\n        \"iconName\" : \"fa-star-o\",\n        \"iconNameText\" : \"Outline star\",\n        \"iconPosition\" : \"beforeText\",\n        \"buttonPosition\" : \"center\",\n        \"buttonSize\" : \"large\",\n        \"referenceType\" : \"navigation\",\n        \"externalLink\" : \"\",\n        \"link\" : \"/menu\",\n        \"openNewWindow\" : \"false\",\n        \"style\" : {\n          \"colorBg\" : \"#ffae52\",\n          \"colorVariantBg\" : \"color-0\",\n          \"colorText\" : \"\",\n          \"colorVariantText\" : \"color-6\"\n        },\n        \"id\" : \"w7d1bbc02-37d7-4a68-9f24-6474ce9014c7\",\n        \"page\" : \"/menu\"\n      } ]\n    }, {\n      \"width\" : \"3\",\n      \"widget\" : [ {\n        \"type\" : \"image\",\n        \"name\" : \"Obraz\",\n        \"url\" : \"vegan3.jpg\",\n        \"imageAlt\" : \"Image\",\n        \"referenceType\" : \"none\",\n        \"externalLink\" : \"\",\n        \"link\" : \"\",\n        \"openNewWindow\" : \"false\",\n        \"content\" : \"\",\n        \"imagePosition\" : \"center\",\n        \"imageSize\" : \"auto\",\n        \"style\" : {\n          \"borderRadius\" : {\n            \"preset\" : \"all\",\n            \"all\" : \"150\",\n            \"individual\" : [ 0, 0, 0, 0 ]\n          },\n          \"width\" : \"400\",\n          \"measurement\" : \"px\"\n        },\n        \"id\" : \"w8a528f68-ec48-4617-b03f-d2b654b25c87\"\n      } ]\n    } ],\n    \"styles\" : {\n      \"backgroundColor\" : \"rgba(254,248,236,1)\",\n      \"backgroundColorVariant\" : \"color-custom\",\n      \"backgroundOpacity\" : \"100\",\n      \"backgroundAttachment\" : \"scroll\"\n    },\n    \"id\" : \"wf3004da6-2db2-47dc-b52b-867e00256ad1\"\n  } ],\n  \"settings\" : {\n    \"cookie\" : {\n      \"label\" : null,\n      \"content\" : null\n    },\n    \"languages\" : [ {\n      \"language\" : \"KU\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_ku\",\n      \"siteLanguageId\" : \"26f0cc1d-b793-11ef-9141-525400080621\"\n    }, {\n      \"language\" : \"EN\",\n      \"defaultLanguage\" : true,\n      \"selected\" : true,\n      \"translated\" : \"admin_lang_en\",\n      \"siteLanguageId\" : \"5829c978-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"PL\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_pl\",\n      \"siteLanguageId\" : \"582a3a1b-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"ES\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_es\",\n      \"siteLanguageId\" : \"582ad3fe-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"ES_LA\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_es_pe\",\n      \"siteLanguageId\" : \"582b399b-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"RU\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_ru\",\n      \"siteLanguageId\" : \"582b946d-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"DE\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_de\",\n      \"siteLanguageId\" : \"582c59f6-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"FR\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_fr\",\n      \"siteLanguageId\" : \"582e1104-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"IT\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_it\",\n      \"siteLanguageId\" : \"582e8832-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"CS\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_cs\",\n      \"siteLanguageId\" : \"5830a6dc-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"EL\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_el\",\n      \"siteLanguageId\" : \"5831318a-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"PT\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_pt\",\n      \"siteLanguageId\" : \"58319125-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"PT_BR\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_pt_br\",\n      \"siteLanguageId\" : \"5832001c-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"SV\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_sv\",\n      \"siteLanguageId\" : \"58328049-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"AR\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_ar\",\n      \"siteLanguageId\" : \"5832eadb-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"HU\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_hu\",\n      \"siteLanguageId\" : \"58334712-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"DA\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_da\",\n      \"siteLanguageId\" : \"58347a6c-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"FI\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_fi\",\n      \"siteLanguageId\" : \"5834cd86-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"SK\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_sk\",\n      \"siteLanguageId\" : \"5835486c-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"NO\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_no\",\n      \"siteLanguageId\" : \"5835d0d4-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"GA\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_ga\",\n      \"siteLanguageId\" : \"58365491-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"SL\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_sl\",\n      \"siteLanguageId\" : \"5837b779-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"LT\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_lt\",\n      \"siteLanguageId\" : \"5838c5c7-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"LV\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_lv\",\n      \"siteLanguageId\" : \"583917f5-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"ET\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_ee\",\n      \"siteLanguageId\" : \"58397e93-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"FO\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_fo\",\n      \"siteLanguageId\" : \"583b3574-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"NL\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_nl\",\n      \"siteLanguageId\" : \"583bb381-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"UK\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_uk\",\n      \"siteLanguageId\" : \"583c6cef-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"HR\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_hr\",\n      \"siteLanguageId\" : \"583cdee1-b93b-11eb-a1e9-525400080521\"\n    }, {\n      \"language\" : \"KA\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_ka\",\n      \"siteLanguageId\" : \"83bd4887-15f1-11ec-a1e9-525400080521\"\n    }, {\n      \"language\" : \"RO\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_ro\",\n      \"siteLanguageId\" : \"a4d1ebfe-c974-11ee-8fee-525400080621\"\n    }, {\n      \"language\" : \"BG\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_bg\",\n      \"siteLanguageId\" : \"cb09a803-f810-11ee-8fee-525400080621\"\n    }, {\n      \"language\" : \"LO\",\n      \"defaultLanguage\" : false,\n      \"selected\" : false,\n      \"translated\" : \"admin_lang_lo\",\n      \"siteLanguageId\" : \"e2460416-f4f0-11eb-a1e9-525400080521\"\n    } ],\n    \"defaultPageId\" : null,\n    \"themeStoreType\" : null,\n    \"coverUrl\" : null\n  },\n  \"popups\" : [ ]\n}");
        ...
        com.upmenu.restaurantSearchForm = {
            ...
            "latitude": null,
            "longitude": null,
            "customAddressField1Value": null,
            "customAddressField2Value": null,
            "customAddressField3Value": null,
            "errors": []
        };
